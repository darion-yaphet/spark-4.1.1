...
public  class BarrierTaskContext extends org.apache.spark.TaskContext implements org.apache.spark.internal.Logging {
  ...
  public  java.util.Map<java.lang.String, org.apache.spark.resource.ResourceInformation> resourcesJMap ()  { throw new RuntimeException(); }
    ...
    boolean interruptible ()  { throw new RuntimeException(); }
    void pendingInterrupt (scala.Option<java.lang.Thread> threadToInterrupt, java.lang.String reason)  { throw new RuntimeException(); }
   <T extends java.io.Closeable> T createResourceUninterruptibly (scala.Function0<T> resourceBuilder)  { throw new RuntimeException(); }
}
