...
public  interface ExecutorAllocationClient {
   ...
   */
  public  scala.collection.immutable.Seq<java.lang.String> decommissionExecutors (scala.Tuple2<java.lang.String, org.apache.spark.scheduler.ExecutorDecommissionInfo>[] executorsAndDecomInfo, boolean adjustTargetNumExecutors, boolean triggeredByExecutor)  ;
  /**
  ...
  /** Get the list of currently active executors */
    scala.collection.immutable.Seq<java.lang.String> getExecutorIds ()  ;
  /**
   ...
   * @return the ids of the executors acknowledged by the cluster manager to be removed.
   */
  public  scala.collection.immutable.Seq<java.lang.String> killExecutors (scala.collection.immutable.Seq<java.lang.String> executorIds, boolean adjustTargetNumExecutors, boolean countFailures, boolean force)  ;
  /**
