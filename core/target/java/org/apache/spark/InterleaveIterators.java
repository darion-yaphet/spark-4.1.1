...
public  class InterleaveIterators<T extends java.lang.Object, R extends java.lang.Object> {
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  public   InterleaveIterators (scala.collection.immutable.Seq<T> data1, scala.Function1<scala.collection.Iterator<T>, R> f1, scala.collection.immutable.Seq<T> data2, scala.Function1<scala.collection.Iterator<T>, R> f2)  { throw new RuntimeException(); }
