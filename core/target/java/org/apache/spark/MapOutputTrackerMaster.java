 ...
 */
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.collection.immutable.Seq<java.lang.Object>> equallyDivide (int numElements, int numBuckets)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<scala.collection.immutable.Seq<java.lang.Object>> findMissingPartitions (int shuffleId)  { throw new RuntimeException(); }
   ...
   */
  public  scala.collection.immutable.Seq<java.lang.String> getMapLocation (org.apache.spark.ShuffleDependency<?, ?, ?> dep, int startMapIndex, int endMapIndex)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.storage.BlockManagerId> getMapOutputLocation (int shuffleId, long mapId)  { throw new RuntimeException(); }
  ...
  public  scala.collection.Iterator<scala.Tuple2<org.apache.spark.storage.BlockManagerId, scala.collection.immutable.Seq<scala.Tuple3<org.apache.spark.storage.BlockId, java.lang.Object, java.lang.Object>>>> getMapSizesForMergeResult (int shuffleId, int partitionId)  { throw new RuntimeException(); }
  public  scala.collection.Iterator<scala.Tuple2<org.apache.spark.storage.BlockManagerId, scala.collection.immutable.Seq<scala.Tuple3<org.apache.spark.storage.BlockId, java.lang.Object, java.lang.Object>>>> getMapSizesForMergeResult (int shuffleId, int partitionId, org.roaringbitmap.RoaringBitmap chunkTracker)  { throw new RuntimeException(); }
   ...
   */
  public  scala.collection.immutable.Seq<java.lang.String> getPreferredLocationsForShuffle (org.apache.spark.ShuffleDependency<?, ?, ?> dep, int partitionId)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getShufflePushMergerLocations (int shuffleId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.collection.immutable.Range> rangeGrouped (scala.collection.immutable.Range range, int size)  { throw new RuntimeException(); }
  public  boolean registerMapOutput (int shuffleId, int mapIndex, org.apache.spark.scheduler.MapStatus status)  { throw new RuntimeException(); }
  ...
  public  void registerMergeResults (int shuffleId, scala.collection.immutable.Seq<scala.Tuple2<java.lang.Object, org.apache.spark.scheduler.MergeStatus>> statuses)  { throw new RuntimeException(); }
  public  void registerShuffle (int shuffleId, int numMaps, int numReduces)  { throw new RuntimeException(); }
  public  void registerShufflePushMergerLocations (int shuffleId, scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> shuffleMergers)  { throw new RuntimeException(); }
  /**
