...
public  class Partitioner$ implements java.io.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.Partitioner defaultPartitioner (org.apache.spark.rdd.RDD<?> rdd, scala.collection.immutable.Seq<org.apache.spark.rdd.RDD<?>> others)  { throw new RuntimeException(); }
}
