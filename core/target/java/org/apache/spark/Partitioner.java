 ...
 */
public abstract class Partitioner implements java.io.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.Partitioner defaultPartitioner (org.apache.spark.rdd.RDD<?> rdd, scala.collection.immutable.Seq<org.apache.spark.rdd.RDD<?>> others)  { throw new RuntimeException(); }
