...
public  class SaveInfoListener extends org.apache.spark.scheduler.SparkListener {
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.StageInfo> getCompletedStageInfos ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskInfo> getCompletedTaskInfos ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskInfo> getCompletedTaskInfos (int stageId, int stageAttemptId)  { throw new RuntimeException(); }
