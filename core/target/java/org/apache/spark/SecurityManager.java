 ...
 */
   ...
   */
  public  void setViewAcls (scala.collection.immutable.Set<java.lang.String> defaultUsers, scala.collection.immutable.Seq<java.lang.String> allowedUsers)  { throw new RuntimeException(); }
  public  void setViewAcls (java.lang.String defaultUser, scala.collection.immutable.Seq<java.lang.String> allowedUsers)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void setViewAclsGroups (scala.collection.immutable.Seq<java.lang.String> allowedUserGroups)  { throw new RuntimeException(); }
  /**
   ...
   * @param allowedUsers (undocumented)
   */
  public  void setModifyAcls (scala.collection.immutable.Set<java.lang.String> defaultUsers, scala.collection.immutable.Seq<java.lang.String> allowedUsers)  { throw new RuntimeException(); }
  /**
   * Admin acls groups should be set before the view or modify acls groups. If you modify the admin
   * acls groups you should also set the view and modify acls groups again to pick up the changes.
   * @param allowedUserGroups (undocumented)
   */
  public  void setModifyAclsGroups (scala.collection.immutable.Seq<java.lang.String> allowedUserGroups)  { throw new RuntimeException(); }
  /**
   * Checking the existence of "*" is necessary as YARN can't recognize the "*" in "defaultuser,*"
   * @return (undocumented)
   */
   ...
   */
  public  void setAdminAcls (scala.collection.immutable.Seq<java.lang.String> adminUsers)  { throw new RuntimeException(); }
  /**
   * Admin acls groups should be set before the view or modify acls groups. If you modify the admin
   * acls groups you should also set the view and modify acls groups again to pick up the changes.
   * @param adminUserGroups (undocumented)
   */
  public  void setAdminAclsGroups (scala.collection.immutable.Seq<java.lang.String> adminUserGroups)  { throw new RuntimeException(); }
   ...
   */
  public  boolean isSslRpcEnabled ()  { throw new RuntimeException(); }
  /**
   * Returns the SSLOptions object for the RPC namespace
   * @return the SSLOptions object for the RPC namespace
   */
  public  org.apache.spark.SSLOptions getRpcSSLOptions ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.collection.immutable.Map<java.lang.String, java.lang.String> getEnvironmentForSslRpcPasswords ()  { throw new RuntimeException(); }
}
