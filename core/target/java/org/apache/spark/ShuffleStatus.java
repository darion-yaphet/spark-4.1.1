...
public  class ShuffleStatus implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
    scala.collection.mutable.Set<java.lang.Object> checksumMismatchIndices ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    scala.collection.mutable.HashMap<java.lang.Object, java.lang.Object> mapIdToMapIndex ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean addMapOutput (int mapIndex, org.apache.spark.scheduler.MapStatus status)  { throw new RuntimeException(); }
  /**
   * Get the map output that corresponding to a given mapId.
   * @param mapId (undocumented)
   * @return (undocumented)
   */
  public  scala.Option<org.apache.spark.scheduler.MapStatus> getMapStatus (long mapId)  { throw new RuntimeException(); }
  /**
  ...
  public  void registerShuffleMergerLocations (scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> shuffleMergers)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.Object> findMissingPartitions ()  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getShufflePushMergerLocations ()  { throw new RuntimeException(); }
  /**
