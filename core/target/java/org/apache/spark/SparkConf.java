 ...
 */
public  class SparkConf implements org.apache.spark.ReadOnlySparkConf, java.lang.Cloneable, org.apache.spark.internal.Logging, java.io.Serializable {
  /**
  ...
  public  org.apache.spark.SparkConf setJars (scala.collection.immutable.Seq<java.lang.String> jars)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.SparkConf setExecutorEnv (scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> variables)  { throw new RuntimeException(); }
  /**
   * Set multiple environment variables to be used when launching executors.
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.SparkConf registerAvroSchemas (scala.collection.immutable.Seq<org.apache.avro.Schema> schemas)  { throw new RuntimeException(); }
  ...
  /**
   * Get all parameters that start with <code>prefix</code> and apply f.
   * @param prefix (undocumented)
   * @param f (undocumented)
   * @return (undocumented)
   */
  public <K extends java.lang.Object> scala.Tuple2<K, java.lang.String>[] getAllWithPrefix (java.lang.String prefix, scala.Function1<java.lang.String, K> f)  { throw new RuntimeException(); }
  /** Get all executor environment variables set on this SparkConf */
  public  scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> getExecutorEnv ()  { throw new RuntimeException(); }
  /**
