...
public  class SparkContext implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  static   scala.collection.immutable.Set<java.lang.String> VALID_LOG_LEVELS ()  { throw new RuntimeException(); }
  /**
  ...
  static   java.lang.String SPARK_JOB_TAGS ()  { throw new RuntimeException(); }
  ...
  static   java.lang.String SPARK_JOB_TAGS_SEP ()  { throw new RuntimeException(); }
  static   void throwIfInvalidTag (java.lang.String tag)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static   org.apache.spark.SparkConf updatedConf (org.apache.spark.SparkConf conf, java.lang.String master, java.lang.String appName, java.lang.String sparkHome, scala.collection.immutable.Seq<java.lang.String> jars, scala.collection.Map<java.lang.String, java.lang.String> environment)  { throw new RuntimeException(); }
  /**
  ...
  static   int executorMemoryInMb (org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
   ...
   */
  public   SparkContext (java.lang.String master, java.lang.String appName, java.lang.String sparkHome, scala.collection.immutable.Seq<java.lang.String> jars, scala.collection.Map<java.lang.String, java.lang.String> environment)  { throw new RuntimeException(); }
  /**
   * Alternative constructor that allows setting common Spark properties directly
   * <p>
   * @param master Cluster URL to connect to (e.g. spark://host:port, local[4]).
   ...
   *             system or HDFS, HTTP, HTTPS, or FTP URLs.
   */
     SparkContext (java.lang.String master, java.lang.String appName, java.lang.String sparkHome, scala.collection.immutable.Seq<java.lang.String> jars)  { throw new RuntimeException(); }
    org.apache.spark.SparkConf conf ()  { throw new RuntimeException(); }
  /** Get a read-only reference to the spark conf. This is preferred version over {@link getConf}. */
  public  org.apache.spark.ReadOnlySparkConf getReadOnlyConf ()  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<java.lang.String> jars ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<java.lang.String> files ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<java.lang.String> archives ()  { throw new RuntimeException(); }
  ...
  public  boolean isStopped ()  { throw new RuntimeException(); }
    ...
    scala.collection.concurrent.Map<java.lang.String, scala.collection.concurrent.Map<java.lang.String, java.lang.Object>> addedFiles ()  { throw new RuntimeException(); }
    scala.collection.concurrent.Map<java.lang.String, scala.collection.concurrent.Map<java.lang.String, java.lang.Object>> addedArchives ()  { throw new RuntimeException(); }
    scala.collection.concurrent.Map<java.lang.String, scala.collection.concurrent.Map<java.lang.String, java.lang.Object>> addedJars ()  { throw new RuntimeException(); }
    scala.collection.immutable.Map<java.lang.String, java.lang.Object> allAddedFiles ()  { throw new RuntimeException(); }
    scala.collection.immutable.Map<java.lang.String, java.lang.Object> allAddedArchives ()  { throw new RuntimeException(); }
    scala.collection.immutable.Map<java.lang.String, java.lang.Object> allAddedJars ()  { throw new RuntimeException(); }
   ...
   */
    ...
    scala.Option<org.apache.spark.status.api.v1.ThreadStackTrace> getTaskThreadDump (long taskId, java.lang.String executorId)  { throw new RuntimeException(); }
  /**
   * Called by the web UI to obtain executor heap histogram.
   * @param executorId (undocumented)
   * @return (undocumented)
   */
    scala.Option<java.lang.String[]> getExecutorHeapHistogram (java.lang.String executorId)  { throw new RuntimeException(); }
   ...
   * <p>
   * To remove/unset property simply set <code>value</code> to null e.g. sc.setLocalProperty("key", null)
   ...
   * @since 3.5.0
   */
  public  void setInterruptOnCancel (boolean interruptOnCancel)  { throw new RuntimeException(); }
  /**
   ...
   * @since 3.5.0
   */
  public  void addJobTag (java.lang.String tag)  { throw new RuntimeException(); }
  /**
   * Add multiple tags to be assigned to all the jobs started by this thread.
   * See {@link addJobTag} for more details.
   * <p>
   * @param tags The tags to be added. Cannot contain ',' (comma) character.
   * <p>
   * @since 4.0.0
   */
  public  void addJobTags (scala.collection.immutable.Set<java.lang.String> tags)  { throw new RuntimeException(); }
  /**
   ...
   * @since 3.5.0
   */
  public  void removeJobTag (java.lang.String tag)  { throw new RuntimeException(); }
  /**
   * Remove multiple tags to be assigned to all the jobs started by this thread.
   * See {@link removeJobTag} for more details.
   * <p>
   * @param tags The tags to be removed. Cannot contain ',' (comma) character.
   * <p>
   * @since 4.0.0
   */
  public  void removeJobTags (scala.collection.immutable.Set<java.lang.String> tags)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Set<java.lang.String> getJobTags ()  { throw new RuntimeException(); }
  /**
   * Clear the current thread's job tags.
   * <p>
   * @since 3.5.0
   */
  public  void clearJobTags ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> org.apache.spark.rdd.RDD<T> parallelize (scala.collection.immutable.Seq<T> seq, int numSlices, scala.reflect.ClassTag<T> evidence$1)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> org.apache.spark.rdd.RDD<T> makeRDD (scala.collection.immutable.Seq<T> seq, int numSlices, scala.reflect.ClassTag<T> evidence$2)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> org.apache.spark.rdd.RDD<T> makeRDD (scala.collection.immutable.Seq<scala.Tuple2<T, scala.collection.immutable.Seq<java.lang.String>>> seq, scala.reflect.ClassTag<T> evidence$3)  { throw new RuntimeException(); }
  /**
  ...
  public <T extends java.lang.Object> org.apache.spark.rdd.RDD<T> union (scala.collection.immutable.Seq<org.apache.spark.rdd.RDD<T>> rdds, scala.reflect.ClassTag<T> evidence$6)  { throw new RuntimeException(); }
  /** Build the union of a list of RDDs passed as variable-length arguments. */
  public <T extends java.lang.Object> org.apache.spark.rdd.RDD<T> union (org.apache.spark.rdd.RDD<T> first, scala.collection.immutable.Seq<org.apache.spark.rdd.RDD<T>> rest, scala.reflect.ClassTag<T> evidence$7)  { throw new RuntimeException(); }
   ...
   */
   <T extends java.lang.Object> org.apache.spark.broadcast.Broadcast<T> broadcastInternal (T value, boolean serializedOnly, scala.reflect.ClassTag<T> evidence$10)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> listFiles ()  { throw new RuntimeException(); }
  /**
   * :: Experimental ::
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> listArchives ()  { throw new RuntimeException(); }
  /**
   * Add a file to be downloaded with this Spark job on every node.
   * <p>
   * If a file is added during execution, it will not be available until the next TaskSet starts.
  ...
  public  void removeSparkListener (org.apache.spark.scheduler.SparkListenerInterface listener)  { throw new RuntimeException(); }
    scala.collection.immutable.Seq<java.lang.String> getExecutorIds ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public  boolean killExecutors (scala.collection.immutable.Seq<java.lang.String> executorIds)  { throw new RuntimeException(); }
  /**
   * :: DeveloperApi ::
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.Schedulable> getAllPools ()  { throw new RuntimeException(); }
  /**
   * :: DeveloperApi ::
   ...
   */
    scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation> getPreferredLocs (org.apache.spark.rdd.RDD<?> rdd, int partition)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> listJars ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void stop (int exitCode)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> void runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.collection.immutable.Seq<java.lang.Object> partitions, scala.Function2<java.lang.Object, U, scala.runtime.BoxedUnit> resultHandler, scala.reflect.ClassTag<U> evidence$11)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.collection.immutable.Seq<java.lang.Object> partitions, scala.reflect.ClassTag<U> evidence$12)  { throw new RuntimeException(); }
  /**
   * Run a function on a given set of partitions in an RDD and return the results as an array.
   * <p>
   * @param rdd target RDD to run tasks on
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function1<scala.collection.Iterator<T>, U> func, scala.collection.immutable.Seq<java.lang.Object> partitions, scala.reflect.ClassTag<U> evidence$13)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.reflect.ClassTag<U> evidence$14)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function1<scala.collection.Iterator<T>, U> func, scala.reflect.ClassTag<U> evidence$15)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object, U extends java.lang.Object, R extends java.lang.Object> org.apache.spark.SimpleFutureAction<R> submitJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function1<scala.collection.Iterator<T>, U> processPartition, scala.collection.immutable.Seq<java.lang.Object> partitions, scala.Function2<java.lang.Object, U, scala.runtime.BoxedUnit> resultHandler, scala.Function0<R> resultFunc)  { throw new RuntimeException(); }
  /**
   ...
   * @since 4.0.0
   */
  public  void cancelJobGroup (java.lang.String groupId, java.lang.String reason)  { throw new RuntimeException(); }
  /**
   * Cancel active jobs for the specified group. See <code>org.apache.spark.SparkContext.setJobGroup</code>
   * for more information.
   * <p>
   ...
   * @since 4.0.0
   */
  public  void cancelJobGroupAndFutureJobs (java.lang.String groupId, java.lang.String reason)  { throw new RuntimeException(); }
  /**
   * Cancel active jobs for the specified group, as well as the future jobs in this job group.
   * Note: the maximum number of job groups that can be tracked is set by
   * 'spark.scheduler.numCancelledJobGroupsToTrack'. Once the limit is reached and a new job group
   ...
   * @param groupId the group ID to cancel
   */
  public  void cancelJobGroupAndFutureJobs (java.lang.String groupId)  { throw new RuntimeException(); }
  /**
   * Cancel active jobs that have the specified tag. See <code>org.apache.spark.SparkContext.addJobTag</code>.
   * <p>
   * @param tag The tag to be cancelled. Cannot contain ',' (comma) character.
   * @param reason reason for cancellation.
   * @return A future with {@link ActiveJob}s, allowing extraction of information such as Job ID and
   *   tags.
   */
    scala.concurrent.Future<scala.collection.immutable.Seq<org.apache.spark.scheduler.ActiveJob>> cancelJobsWithTagWithFuture (java.lang.String tag, java.lang.String reason)  { throw new RuntimeException(); }
  /**
   * Cancel active jobs that have the specified tag. See <code>org.apache.spark.SparkContext.addJobTag</code>.
   * <p>
   * @param tag The tag to be cancelled. Cannot contain ',' (comma) character.
   ...
   * @since 4.0.0
   */
  public  void cancelJobsWithTag (java.lang.String tag, java.lang.String reason)  { throw new RuntimeException(); }
  /**
   * Cancel active jobs that have the specified tag. See <code>org.apache.spark.SparkContext.addJobTag</code>.
   * <p>
   * @param tag The tag to be cancelled. Cannot contain ',' (comma) character.
   ...
   * @since 3.5.0
   */
  public  void cancelJobsWithTag (java.lang.String tag)  { throw new RuntimeException(); }
  ...
  /** Post the environment update event once the task scheduler is ready */
    void postEnvironmentUpdate ()  { throw new RuntimeException(); }
}
