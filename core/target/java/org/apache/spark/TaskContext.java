...
public abstract class TaskContext implements java.io.Serializable {
  ...
  static public <T extends java.lang.Object> T withTaskContext (org.apache.spark.TaskContext context, scala.Function0<T> task)  { throw new RuntimeException(); }
  /**
  ...
  /** Runs a task with this context, ensuring failure and completion listeners get triggered. */
   <T extends java.lang.Object> T runTaskWithListeners (org.apache.spark.scheduler.Task<T> task)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public abstract  scala.collection.immutable.Seq<org.apache.spark.metrics.source.Source> getMetricsSources (java.lang.String sourceName)  ;
  /**
  ...
  /** Whether the current task is allowed to interrupt. */
   abstract  boolean interruptible ()  ;
  /**
   * Pending the interruption request until the task is able to
   * interrupt after creating the resource uninterruptibly.
   * @param threadToInterrupt (undocumented)
   * @param reason (undocumented)
   */
   abstract  void pendingInterrupt (scala.Option<java.lang.Thread> threadToInterrupt, java.lang.String reason)  ;
  /**
   ...
   *  }
   * </code></pre>
   * @param resourceBuilder (undocumented)
   * @return (undocumented)
   */
   abstract <T extends java.io.Closeable> T createResourceUninterruptibly (scala.Function0<T> resourceBuilder)  ;
}
