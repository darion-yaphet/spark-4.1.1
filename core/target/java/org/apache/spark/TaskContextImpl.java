 ...
 */
  ...
  // not preceding
  public   TaskContextImpl (int stageId, int stageAttemptNumber, int partitionId, long taskAttemptId, int attemptNumber, int numPartitions, org.apache.spark.memory.TaskMemoryManager taskMemoryManager, java.util.Properties localProperties, org.apache.spark.metrics.MetricsSystem metricsSystem, org.apache.spark.executor.TaskMetrics taskMetrics, int cpus, scala.collection.immutable.Map<java.lang.String, org.apache.spark.resource.ResourceInformation> resources)  { throw new RuntimeException(); }
  public  scala.Option<scala.Tuple2<scala.Option<java.lang.Thread>, java.lang.String>> pendingInterruptRequest ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.metrics.source.Source> getMetricsSources (java.lang.String sourceName)  { throw new RuntimeException(); }
  ...
  public  boolean interruptible ()  { throw new RuntimeException(); }
  public  void pendingInterrupt (scala.Option<java.lang.Thread> threadToInterrupt, java.lang.String reason)  { throw new RuntimeException(); }
  public <T extends java.io.Closeable> T createResourceUninterruptibly (scala.Function0<T> resourceBuilder)  { throw new RuntimeException(); }
}
