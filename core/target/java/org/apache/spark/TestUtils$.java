 ...
 */
public  class TestUtils$ implements org.apache.spark.util.SparkTestUtils {
  /**
   ...
   * @return (undocumented)
   */
  public  java.net.URL createJar (scala.collection.immutable.Seq<java.io.File> files, java.io.File jarFile, scala.Option<java.lang.String> directoryPrefix, scala.Option<java.lang.String> mainClass)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String minimumPythonSupportedVersion ()  { throw new RuntimeException(); }
  public  boolean isPythonVersionAvailable ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int httpResponseCode (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String redirectUrl (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String httpResponseMessage (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  public <T extends java.lang.Object> T withHttpConnection (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers, scala.Function1<java.net.HttpURLConnection, T> fn)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String createTempJsonFile (java.io.File dir, java.lang.String prefix, org.json4s.JValue jsonValue)  { throw new RuntimeException(); }
