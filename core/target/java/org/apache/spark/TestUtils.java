...
public  class TestUtils {
   ...
   * @return (undocumented)
   */
  static public  java.net.URL createJarWithClasses (scala.collection.immutable.Seq<java.lang.String> classNames, java.lang.String toStringValue, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> classNamesWithBase, scala.collection.immutable.Seq<java.net.URL> classpathUrls)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.net.URL createJar (scala.collection.immutable.Seq<java.io.File> files, java.io.File jarFile, scala.Option<java.lang.String> directoryPrefix, scala.Option<java.lang.String> mainClass)  { throw new RuntimeException(); }
  /**
  ...
  static public  java.lang.String minimumPythonSupportedVersion ()  { throw new RuntimeException(); }
  static public  boolean isPythonVersionAvailable ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  int httpResponseCode (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.lang.String redirectUrl (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.lang.String httpResponseMessage (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object> T withHttpConnection (java.net.URL url, java.lang.String method, scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> headers, scala.Function1<java.net.HttpURLConnection, T> fn)  { throw new RuntimeException(); }
  /**
  ...
  static public  java.lang.String createTempJsonFile (java.io.File dir, java.lang.String prefix, org.json4s.JValue jsonValue)  { throw new RuntimeException(); }
  ...
  static public  javax.tools.JavaFileObject.Kind org$apache$spark$util$SparkTestUtils$$SOURCE ()  { throw new RuntimeException(); }
  static public  java.io.File createCompiledClass (java.lang.String className, java.io.File destDir, org.apache.spark.util.SparkTestUtils.JavaSourceFromString sourceFile, scala.collection.immutable.Seq<java.net.URL> classpathUrls)  { throw new RuntimeException(); }
  static public  java.io.File createCompiledClass (java.lang.String className, java.io.File destDir, java.lang.String toStringValue, java.lang.String baseClass, scala.collection.immutable.Seq<java.net.URL> classpathUrls, scala.collection.immutable.Seq<java.lang.String> implementsClasses, java.lang.String extraCodeBody, scala.Option<java.lang.String> packageName)  { throw new RuntimeException(); }
  static public  java.lang.String createCompiledClass$default$3 ()  { throw new RuntimeException(); }
  static public  java.lang.String createCompiledClass$default$4 ()  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<java.net.URL> createCompiledClass$default$5 ()  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<java.lang.String> createCompiledClass$default$6 ()  { throw new RuntimeException(); }
  static public  java.lang.String createCompiledClass$default$7 ()  { throw new RuntimeException(); }
  static public  scala.Option<java.lang.String> createCompiledClass$default$8 ()  { throw new RuntimeException(); }
  static protected abstract  void org$apache$spark$util$SparkTestUtils$_setter_$org$apache$spark$util$SparkTestUtils$$SOURCE_$eq (javax.tools.JavaFileObject.Kind x$1)  ;
}
