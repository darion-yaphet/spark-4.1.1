...
public  class JavaSparkContext implements java.io.Closeable {
  ...
  /** Build the union of JavaRDDs. */
  public <T extends java.lang.Object> org.apache.spark.api.java.JavaRDD<T> union (scala.collection.immutable.Seq<org.apache.spark.api.java.JavaRDD<T>> rdds)  { throw new RuntimeException(); }
  /** Build the union of JavaPairRDDs. */
  public <K extends java.lang.Object, V extends java.lang.Object> org.apache.spark.api.java.JavaPairRDD<K, V> union (scala.collection.immutable.Seq<org.apache.spark.api.java.JavaPairRDD<K, V>> rdds)  { throw new RuntimeException(); }
  /** Build the union of JavaDoubleRDDs. */
  public  org.apache.spark.api.java.JavaDoubleRDD union (scala.collection.immutable.Seq<org.apache.spark.api.java.JavaDoubleRDD> rdds)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.util.Set<java.lang.String> getJobTags ()  { throw new RuntimeException(); }
  /**
