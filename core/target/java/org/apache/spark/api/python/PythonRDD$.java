...
public  class PythonRDD$ implements org.apache.spark.internal.Logging, java.io.Serializable {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final PythonRDD$ MODULE$ = null;
  public   PythonRDD$ ()  { throw new RuntimeException(); }
  public  scala.collection.mutable.Set<java.lang.Object> getWorkerBroadcasts (org.apache.spark.api.python.PythonWorker worker)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Writes the next element of the iterator <code>iter</code> to <code>dataOut</code>. Returns true if any data was
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> boolean writeNextElementToStream (scala.collection.Iterator<T> iter, java.io.DataOutputStream dataOut)  { throw new RuntimeException(); }
   ...
   */
  public  java.lang.Object[] serveIterator (scala.collection.Iterator<java.lang.Object> items, java.lang.String threadName)  { throw new RuntimeException(); }
  /**
