...
public  class RUtils {
   ...
   * @return (undocumented)
   */
  static public  scala.collection.immutable.Seq<java.lang.String> sparkRPackagePath (boolean isDriver)  { throw new RuntimeException(); }
  ...
  static public  java.lang.String[] getJobTags (org.apache.spark.api.java.JavaSparkContext sc)  { throw new RuntimeException(); }
}
