 ...
 */
  class Benchmark {
  static public  class Case implements scala.Product, java.io.Serializable {
  ...
  static public  class Case$ extends scala.runtime.AbstractFunction3<java.lang.String, scala.Function1<org.apache.spark.benchmark.Benchmark.Timer, scala.runtime.BoxedUnit>, java.lang.Object, org.apache.spark.benchmark.Benchmark.Case> implements java.io.Serializable {
    /**
  ...
  static public  class Result implements scala.Product, java.io.Serializable {
  ...
  static public  class Result$ extends scala.runtime.AbstractFunction4<java.lang.Object, java.lang.Object, java.lang.Object, java.lang.Object, org.apache.spark.benchmark.Benchmark.Result> implements java.io.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
   ...
   * provide some baseline. If <code>relativeTime</code> is set to <code>true</code>, the <code>Relative</code> column will be
   ...
   * @param relativeTime (undocumented)
   */
  public  void run (boolean relativeTime)  { throw new RuntimeException(); }
  /**
