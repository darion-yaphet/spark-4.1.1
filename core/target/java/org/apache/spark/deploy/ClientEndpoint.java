...
public  class ClientEndpoint implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.apache.spark.internal.Logging {
  // not preceding
  public   ClientEndpoint (org.apache.spark.rpc.RpcEnv rpcEnv, org.apache.spark.deploy.ClientArguments driverArgs, scala.collection.immutable.Seq<org.apache.spark.rpc.RpcEndpointRef> masterEndpoints, org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
