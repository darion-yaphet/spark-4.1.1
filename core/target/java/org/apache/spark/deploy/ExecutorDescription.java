 ...
 * failover.
 */
  class ExecutorDescription implements java.io.Serializable {
  // not preceding
  public   ExecutorDescription (java.lang.String appId, int execId, int rpId, int cores, int memoryMb, scala.Enumeration.Value state)  { throw new RuntimeException(); }
  ...
  public  int memoryMb ()  { throw new RuntimeException(); }
