...
public  class JsonProtocol$ {
   ...
   */
  public  org.json4s.JObject writeWorkerInfo (org.apache.spark.deploy.master.WorkerInfo obj)  { throw new RuntimeException(); }
  /**
   ...
   * @param obj (undocumented)
   */
  public  org.json4s.JObject writeApplicationInfo (org.apache.spark.deploy.master.ApplicationInfo obj)  { throw new RuntimeException(); }
  /**
   ...
   * @param obj (undocumented)
   */
  public  org.json4s.JObject writeApplicationDescription (org.apache.spark.deploy.ApplicationDescription obj)  { throw new RuntimeException(); }
  /**
   ...
   * @param obj (undocumented)
   */
  public  org.json4s.JObject writeExecutorRunner (org.apache.spark.deploy.worker.ExecutorRunner obj)  { throw new RuntimeException(); }
  /**
   ...
   * @param obj (undocumented)
   */
  public  org.json4s.JObject writeDriverInfo (org.apache.spark.deploy.master.DriverInfo obj)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.json4s.JObject writeMasterState (org.apache.spark.deploy.DeployMessages.MasterStateResponse obj, scala.Option<java.lang.String> field)  { throw new RuntimeException(); }
  /**
   ...
   * @param obj (undocumented)
   */
  public  org.json4s.JObject writeWorkerState (org.apache.spark.deploy.DeployMessages.WorkerStateResponse obj)  { throw new RuntimeException(); }
  /**
   * Export the cluster utilization based on the {@link MasterStateResponse} to a Json object.
   * @param obj (undocumented)
   * @return (undocumented)
   */
  public  org.json4s.JObject writeClusterUtilization (org.apache.spark.deploy.DeployMessages.MasterStateResponse obj)  { throw new RuntimeException(); }
}
