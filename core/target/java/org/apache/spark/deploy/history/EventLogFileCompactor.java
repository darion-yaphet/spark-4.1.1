...
public  class EventLogFileCompactor implements org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.deploy.history.CompactionResult compact (scala.collection.immutable.Seq<org.apache.hadoop.fs.FileStatus> eventLogFiles)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    java.lang.String rewrite (scala.collection.immutable.Seq<org.apache.spark.deploy.history.EventFilter> filters, scala.collection.immutable.Seq<org.apache.hadoop.fs.FileStatus> eventLogFiles)  { throw new RuntimeException(); }
}
