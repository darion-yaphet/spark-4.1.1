...
public abstract class EventLogFileWritersSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.LocalSparkContext, org.scalatest.BeforeAndAfter {
  ...
  public  scala.collection.immutable.Seq<scala.Option<java.lang.String>> allCodecs ()  { throw new RuntimeException(); }
   ...
   */
  protected abstract  void verifyWriteEventLogFile (java.lang.String appId, scala.Option<java.lang.String> appAttemptId, java.net.URI logBaseDir, scala.Option<java.lang.String> compressionCodecShortName, scala.collection.immutable.Seq<java.lang.String> expectedLines)  ;
}
