...
public  class SingleEventLogFileWriterSuite extends org.apache.spark.deploy.history.EventLogFileWritersSuite {
  ...
  protected  void verifyWriteEventLogFile (java.lang.String appId, scala.Option<java.lang.String> appAttemptId, java.net.URI logBaseDir, scala.Option<java.lang.String> compressionCodecShortName, scala.collection.immutable.Seq<java.lang.String> expectedLines)  { throw new RuntimeException(); }
}
