package org.apache.spark.deploy.master;
  class ExecutorDesc {
  // not preceding
  public   ExecutorDesc (int id, org.apache.spark.deploy.master.ApplicationInfo application, org.apache.spark.deploy.master.WorkerInfo worker, int cores, int memory, scala.collection.immutable.Map<java.lang.String, org.apache.spark.resource.ResourceInformation> resources, int rpId)  { throw new RuntimeException(); }
