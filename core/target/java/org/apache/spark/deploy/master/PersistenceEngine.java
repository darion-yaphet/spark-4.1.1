...
public abstract class PersistenceEngine {
   ...
   * @return (undocumented)
   */
  public abstract <T extends java.lang.Object> scala.collection.immutable.Seq<T> read (java.lang.String prefix, scala.reflect.ClassTag<T> evidence$1)  ;
  /**
   ...
   * @return (undocumented)
   */
  public final  scala.Tuple3<scala.collection.immutable.Seq<org.apache.spark.deploy.master.ApplicationInfo>, scala.collection.immutable.Seq<org.apache.spark.deploy.master.DriverInfo>, scala.collection.immutable.Seq<org.apache.spark.deploy.master.WorkerInfo>> readPersistedData (org.apache.spark.rpc.RpcEnv rpcEnv)  { throw new RuntimeException(); }
