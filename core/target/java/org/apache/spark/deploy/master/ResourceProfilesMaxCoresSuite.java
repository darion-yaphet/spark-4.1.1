...
public  class ResourceProfilesMaxCoresSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.deploy.master.MasterSuiteBase {
  public  org.scalatest.concurrent.AbstractPatienceConfiguration.PatienceConfig$ PatienceConfig ()  { throw new RuntimeException(); }
  public  org.scalatest.PrivateMethodTester.PrivateMethod$ PrivateMethod ()  { throw new RuntimeException(); }
  public   ResourceProfilesMaxCoresSuite ()  { throw new RuntimeException(); }
  public  scala.util.matching.Regex WORKER_LINK_RE ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<org.apache.spark.deploy.master.ApplicationInfo> _createApplication ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<org.apache.spark.deploy.DriverDescription> _maybeUpdateAppName ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<java.lang.String> _newApplicationId ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<java.lang.String> _newDriverId ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<scala.runtime.BoxedUnit> _schedule ()  { throw new RuntimeException(); }
  protected  org.scalatest.PrivateMethodTester.PrivateMethod<scala.collection.mutable.ArrayBuffer<org.apache.spark.deploy.master.DriverInfo>> _waitingDrivers ()  { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.deploy.master.WorkerInfo workerInfo ()  { throw new RuntimeException(); }
