 ...
 */
  ...
  static public  scala.collection.immutable.Seq<java.lang.String> supportedMasterPrefixes ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.deploy.rest.SubmitRestProtocolResponse killAllSubmissions ()  { throw new RuntimeException(); }
  /** Request that the server clears all submissions and applications. */
  public  org.apache.spark.deploy.rest.SubmitRestProtocolResponse clear ()  { throw new RuntimeException(); }
  /** Check the readiness of Master. */
  public  org.apache.spark.deploy.rest.SubmitRestProtocolResponse readyz ()  { throw new RuntimeException(); }
