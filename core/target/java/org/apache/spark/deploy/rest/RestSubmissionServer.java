 ...
 */
 abstract class RestSubmissionServer implements org.apache.spark.internal.Logging {
  ...
  protected abstract  org.apache.spark.deploy.rest.KillAllRequestServlet killAllRequestServlet ()  ;
  protected abstract  org.apache.spark.deploy.rest.StatusRequestServlet statusRequestServlet ()  ;
  protected abstract  org.apache.spark.deploy.rest.ClearRequestServlet clearRequestServlet ()  ;
  protected abstract  org.apache.spark.deploy.rest.ReadyzRequestServlet readyzRequestServlet ()  ;
    scala.Option<org.eclipse.jetty.server.Server> _server ()  { throw new RuntimeException(); }
