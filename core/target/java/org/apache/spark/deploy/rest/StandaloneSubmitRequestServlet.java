 ...
 */
   ...
   * @param masterRestPort (undocumented)
   * @return (undocumented)
   */
    org.apache.spark.deploy.DriverDescription buildDriverDescription (org.apache.spark.deploy.rest.CreateSubmissionRequest request, java.lang.String masterUrl, int masterRestPort)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  protected  org.apache.spark.deploy.rest.SubmitRestProtocolResponse handleSubmit (java.lang.String requestMessageJson, org.apache.spark.deploy.rest.SubmitRestProtocolMessage requestMessage, jakarta.servlet.http.HttpServletResponse responseServlet)  { throw new RuntimeException(); }
}
