 ...
 */
 abstract class SubmitRequestServlet extends org.apache.spark.deploy.rest.RestServlet {
   ...
   */
  protected  void doPost (jakarta.servlet.http.HttpServletRequest requestServlet, jakarta.servlet.http.HttpServletResponse responseServlet)  { throw new RuntimeException(); }
  protected abstract  org.apache.spark.deploy.rest.SubmitRestProtocolResponse handleSubmit (java.lang.String requestMessageJson, org.apache.spark.deploy.rest.SubmitRestProtocolMessage requestMessage, jakarta.servlet.http.HttpServletResponse responseServlet)  ;
}
