...
public  class WorkerSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.matchers.must.Matchers, org.scalatest.BeforeAndAfter, org.scalatest.PrivateMethodTester {
  ...
  public  org.apache.spark.deploy.Command cmd (scala.collection.immutable.Seq<java.lang.String> javaOpts)  { throw new RuntimeException(); }
  public  org.scalatest.verbs.CompileWord compile ()  { throw new RuntimeException(); }
  public  org.apache.spark.SparkConf conf (scala.collection.immutable.Seq<scala.Tuple2<java.lang.String, java.lang.String>> opts)  { throw new RuntimeException(); }
