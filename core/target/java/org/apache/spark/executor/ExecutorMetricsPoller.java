 ...
 */
  class ExecutorMetricsPoller implements org.apache.spark.internal.Logging {
    class TCMP implements scala.Product, java.io.Serializable {
    static public abstract  R apply (T1 v1, T2 v2)  ;
    static public  java.lang.String toString ()  { throw new RuntimeException(); }
    public  long count ()  { throw new RuntimeException(); }
    public  java.util.concurrent.atomic.AtomicLongArray peaks ()  { throw new RuntimeException(); }
    // not preceding
    public   TCMP (long count, java.util.concurrent.atomic.AtomicLongArray peaks)  { throw new RuntimeException(); }
  }
  public  class TCMP$ extends scala.runtime.AbstractFunction2<java.lang.Object, java.util.concurrent.atomic.AtomicLongArray, org.apache.spark.executor.ExecutorMetricsPoller.TCMP> implements java.io.Serializable {
    /**
