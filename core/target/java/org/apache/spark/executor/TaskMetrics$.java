...
public  class TaskMetrics$ implements org.apache.spark.internal.Logging, java.io.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.executor.TaskMetrics fromAccumulatorInfos (scala.collection.immutable.Seq<org.apache.spark.scheduler.AccumulableInfo> infos)  { throw new RuntimeException(); }
  /**
   * Construct a {@link TaskMetrics} object from a list of accumulator updates, called on driver only.
   * @param accums (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.executor.TaskMetrics fromAccumulators (scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accums)  { throw new RuntimeException(); }
}
