 ...
 */
public  class TaskMetrics implements java.io.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.executor.TaskMetrics fromAccumulatorInfos (scala.collection.immutable.Seq<org.apache.spark.scheduler.AccumulableInfo> infos)  { throw new RuntimeException(); }
  /**
   * Construct a {@link TaskMetrics} object from a list of accumulator updates, called on driver only.
   * @param accums (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.executor.TaskMetrics fromAccumulators (scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accums)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  long peakOnHeapExecutionMemory ()  { throw new RuntimeException(); }
  /**
   * Peak off heap execution memory as tracked by TaskMemoryManager.
   * @return (undocumented)
   */
  public  long peakOffHeapExecutionMemory ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.Tuple2<org.apache.spark.storage.BlockId, org.apache.spark.storage.BlockStatus>> updatedBlockStatuses ()  { throw new RuntimeException(); }
    ...
    void setPeakOnHeapExecutionMemory (long v)  { throw new RuntimeException(); }
    void setPeakOffHeapExecutionMemory (long v)  { throw new RuntimeException(); }
    ...
    void setUpdatedBlockStatuses (scala.collection.immutable.Seq<scala.Tuple2<org.apache.spark.storage.BlockId, org.apache.spark.storage.BlockStatus>> v)  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
    scala.collection.mutable.LinkedHashMap<java.lang.String, org.apache.spark.util.AccumulatorV2<? extends java.lang.Object, ? super java.util.List<scala.Tuple2<org.apache.spark.storage.BlockId, org.apache.spark.storage.BlockStatus>>>> nameToAccums ()  { throw new RuntimeException(); }
  // not preceding
    scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> internalAccums ()  { throw new RuntimeException(); }
    void register (org.apache.spark.SparkContext sc)  { throw new RuntimeException(); }
  // not preceding
    scala.collection.mutable.ArrayBuffer<org.apache.spark.util.AccumulatorV2<?, ?>> _externalAccums ()  { throw new RuntimeException(); }
  /**
   * Perform an <code>op</code> conversion on the <code>_externalAccums</code> within the read lock.
   * <p>
   * Note <code>op</code> is expected to not modify the <code>_externalAccums</code> and not being
   * lazy evaluation for safe concern since <code>ArrayBuffer</code> is lazily evaluated.
   * And we intentionally keeps <code>_externalAccums</code> as mutable instead of converting
   * it to immutable for the performance concern.
   * @param op (undocumented)
   * @return (undocumented)
   */
   <T extends java.lang.Object> T withExternalAccums (scala.Function1<scala.collection.mutable.ArrayBuffer<org.apache.spark.util.AccumulatorV2<?, ?>>, T> op)  { throw new RuntimeException(); }
    void registerAccumulator (org.apache.spark.util.AccumulatorV2<?, ?> a)  { throw new RuntimeException(); }
    scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accumulators ()  { throw new RuntimeException(); }
    scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> nonZeroInternalAccums ()  { throw new RuntimeException(); }
}
