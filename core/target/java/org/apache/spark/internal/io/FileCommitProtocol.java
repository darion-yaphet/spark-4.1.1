...
public abstract class FileCommitProtocol implements org.apache.spark.internal.Logging {
  ...
  static public  class TaskCommitMessage implements java.io.Serializable {
    // not preceding
   ...
   */
  public abstract  void commitJob (org.apache.hadoop.mapreduce.JobContext jobContext, scala.collection.immutable.Seq<org.apache.spark.internal.io.FileCommitProtocol.TaskCommitMessage> taskCommits)  ;
  /**
