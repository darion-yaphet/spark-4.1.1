...
public  class GarbageCollectionMetrics {
  static public  scala.collection.immutable.Seq<java.lang.String> names ()  { throw new RuntimeException(); }
  static   scala.collection.immutable.Seq<java.lang.String> YOUNG_GENERATION_BUILTIN_GARBAGE_COLLECTORS ()  { throw new RuntimeException(); }
  static   scala.collection.immutable.Seq<java.lang.String> OLD_GENERATION_BUILTIN_GARBAGE_COLLECTORS ()  { throw new RuntimeException(); }
  static   java.lang.String BUILTIN_CONCURRENT_GARBAGE_COLLECTOR ()  { throw new RuntimeException(); }
