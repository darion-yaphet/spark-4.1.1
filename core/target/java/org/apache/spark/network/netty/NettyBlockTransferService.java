 ...
 */
  class NettyBlockTransferService extends org.apache.spark.network.BlockTransferService implements org.apache.spark.internal.Logging {
  // not preceding
  public  java.lang.String hostName ()  { throw new RuntimeException(); }
  // not preceding
  public   NettyBlockTransferService (org.apache.spark.SparkConf conf, org.apache.spark.SecurityManager securityManager, org.apache.spark.serializer.SerializerManager serializerManager, java.lang.String bindAddress, java.lang.String hostName, int _port, int numCores, org.apache.spark.rpc.RpcEndpointRef driverEndPointRef)  { throw new RuntimeException(); }
