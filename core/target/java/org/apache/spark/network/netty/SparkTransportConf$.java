...
public  class SparkTransportConf$ {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.network.util.TransportConf fromSparkConf (org.apache.spark.SparkConf _conf, java.lang.String module, int numUsableCores, scala.Option<java.lang.String> role, scala.Option<org.apache.spark.SSLOptions> sslOptions)  { throw new RuntimeException(); }
}
