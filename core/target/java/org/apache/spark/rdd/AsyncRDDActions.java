 ...
 */
public  class AsyncRDDActions<T extends java.lang.Object> implements java.io.Serializable, org.apache.spark.internal.Logging {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.FutureAction<scala.collection.immutable.Seq<T>> collectAsync ()  { throw new RuntimeException(); }
  /**
   * Returns a future for retrieving the first num elements of the RDD.
   * @param num (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.FutureAction<scala.collection.immutable.Seq<T>> takeAsync (int num)  { throw new RuntimeException(); }
  /**
