...
public  class HadoopRDD$ implements org.apache.spark.internal.Logging, java.io.Serializable {
  /**
  ...
  public  void addLocalConfiguration (java.lang.String jobTrackerId, int jobId, int splitId, int attemptId, org.apache.hadoop.mapred.JobConf conf)  { throw new RuntimeException(); }
    scala.Option<scala.collection.immutable.Seq<java.lang.String>> convertSplitLocationInfo (org.apache.hadoop.mapred.SplitLocationInfo[] infos)  { throw new RuntimeException(); }
}
