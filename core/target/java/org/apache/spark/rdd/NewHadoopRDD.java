...
public  class NewHadoopRDD<K extends java.lang.Object, V extends java.lang.Object> extends org.apache.spark.rdd.RDD<scala.Tuple2<K, V>> implements org.apache.spark.internal.Logging {
  ...
  static public  class NewHadoopMapPartitionsWithSplitRDD$ implements java.io.Serializable {
    /**
  ...
  // not preceding
  public   NewHadoopRDD (org.apache.spark.SparkContext sc, java.lang.Class<? extends org.apache.hadoop.mapreduce.InputFormat<K, V>> inputFormatClass, java.lang.Class<K> keyClass, java.lang.Class<V> valueClass, org.apache.hadoop.conf.Configuration _conf, boolean ignoreCorruptFiles, boolean ignoreMissingFiles)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<java.lang.String> getPreferredLocations (org.apache.spark.Partition hsplit)  { throw new RuntimeException(); }
