 ...
 */
  class ResourceAllocation implements scala.Product, java.io.Serializable {
  ...
  // not preceding
  public   ResourceAllocation (org.apache.spark.resource.ResourceID id, scala.collection.immutable.Seq<java.lang.String> addresses)  { throw new RuntimeException(); }
