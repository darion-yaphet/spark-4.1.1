...
public  class ResourceAmountUtils {
   ...
   * @return (undocumented)
   */
  static public final  long ONE_ENTIRE_RESOURCE ()  { throw new RuntimeException(); }
  static public  boolean isOneEntireResource (long amount)  { throw new RuntimeException(); }
  static public  long toInternalResource (double amount)  { throw new RuntimeException(); }
  static public  double toFractionalResource (long amount)  { throw new RuntimeException(); }
}
