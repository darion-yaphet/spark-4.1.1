...
public  class ResourceInformation implements java.io.Serializable {
  ...
  static public  org.apache.spark.resource.ResourceInformation parseJson (org.json4s.JValue json)  { throw new RuntimeException(); }
  ...
  public final  org.json4s.JValue toJson ()  { throw new RuntimeException(); }
}
