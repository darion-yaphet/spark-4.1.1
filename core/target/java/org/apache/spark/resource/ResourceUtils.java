...
public  class ResourceUtils {
  ...
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceID> listResourceIds (org.apache.spark.SparkConf sparkConf, java.lang.String componentName)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceRequest> parseAllResourceRequests (org.apache.spark.SparkConf sparkConf, java.lang.String componentName)  { throw new RuntimeException(); }
  ...
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceRequirement> parseResourceRequirements (org.apache.spark.SparkConf sparkConf, java.lang.String componentName)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceRequirement> executorResourceRequestToRequirement (scala.collection.immutable.Seq<org.apache.spark.resource.ExecutorResourceRequest> resourceRequest)  { throw new RuntimeException(); }
  static public  boolean resourcesMeetRequirements (scala.collection.immutable.Map<java.lang.String, java.lang.Object> resourcesFree, scala.collection.immutable.Seq<org.apache.spark.resource.ResourceRequirement> resourceRequirements)  { throw new RuntimeException(); }
  static public <T extends java.lang.Object> scala.collection.immutable.Seq<T> withResourcesJson (java.lang.String resourcesFile, scala.Function1<java.lang.String, scala.collection.immutable.Seq<T>> extract)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceAllocation> parseAllocatedFromJsonFile (java.lang.String resourcesFile)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.resource.ResourceAllocation> parseAllocated (scala.Option<java.lang.String> resourcesFileOpt, java.lang.String componentName)  { throw new RuntimeException(); }
  /**
