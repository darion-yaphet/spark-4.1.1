...
public  class RpcTimeout$ implements java.io.Serializable {
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.rpc.RpcTimeout apply (org.apache.spark.SparkConf conf, scala.collection.immutable.Seq<java.lang.String> timeoutPropList, java.lang.String defaultValue)  { throw new RuntimeException(); }
}
