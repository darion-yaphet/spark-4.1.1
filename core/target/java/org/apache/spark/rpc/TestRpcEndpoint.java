...
public  class TestRpcEndpoint implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.scalactic.TripleEquals {
  ...
  public  void verifyOnConnectedMessages (scala.collection.immutable.Seq<org.apache.spark.rpc.RpcAddress> expected)  { throw new RuntimeException(); }
  public  void verifyOnDisconnectedMessages (scala.collection.immutable.Seq<org.apache.spark.rpc.RpcAddress> expected)  { throw new RuntimeException(); }
  public  void verifyOnNetworkErrorMessages (scala.collection.immutable.Seq<scala.Tuple2<java.lang.Throwable, org.apache.spark.rpc.RpcAddress>> expected)  { throw new RuntimeException(); }
  public  void verifyReceiveAndReplyMessages (scala.collection.immutable.Seq<java.lang.Object> expected)  { throw new RuntimeException(); }
  public  void verifyReceiveMessages (scala.collection.immutable.Seq<java.lang.Object> expected)  { throw new RuntimeException(); }
