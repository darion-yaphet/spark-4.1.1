 ...
 */
  class ActiveJob {
  // not preceding
  public   ActiveJob (int jobId, org.apache.spark.scheduler.Stage finalStage, org.apache.spark.util.CallSite callSite, org.apache.spark.scheduler.JobListener listener, org.apache.spark.JobArtifactSet artifacts, java.util.Properties properties)  { throw new RuntimeException(); }
