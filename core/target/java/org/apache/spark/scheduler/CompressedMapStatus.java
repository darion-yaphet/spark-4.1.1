 ...
 */
  ...
  public   CompressedMapStatus (org.apache.spark.storage.BlockManagerId loc, byte[] compressedSizes, long _mapTaskId, long _checksumVal)  { throw new RuntimeException(); }
  protected   CompressedMapStatus ()  { throw new RuntimeException(); }
  public   CompressedMapStatus (org.apache.spark.storage.BlockManagerId loc, long[] uncompressedSizes, long mapTaskId, long checksumVal)  { throw new RuntimeException(); }
  ...
  public  long checksumValue ()  { throw new RuntimeException(); }
