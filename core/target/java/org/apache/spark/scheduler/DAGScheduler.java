 ...
 */
   ...
   */
    ...
    org.apache.spark.scheduler.LimitedSizeFIFOSet<java.lang.String> cancelledJobGroups ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
    int maxStageAttempts ()  { throw new RuntimeException(); }
  /**
   * Whether ignore stage fetch failure caused by executor decommission when
   * count spark.stage.maxConsecutiveAttempts
   * @return (undocumented)
   */
    boolean ignoreDecommissionFetchFailure ()  { throw new RuntimeException(); }
  /**
   ...
   */
    ...
    void setEventProcessLoop (org.apache.spark.scheduler.DAGSchedulerEventProcessLoop loop)  { throw new RuntimeException(); }
  /**
   ...
   * @param taskInfo (undocumented)
   */
  public  void taskEnded (org.apache.spark.scheduler.Task<?> task, org.apache.spark.TaskEndReason reason, Object result, scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accumUpdates, long[] metricPeaks, org.apache.spark.scheduler.TaskInfo taskInfo)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean executorHeartbeatReceived (java.lang.String execId, scala.Tuple4<java.lang.Object, java.lang.Object, java.lang.Object, scala.collection.immutable.Seq<org.apache.spark.scheduler.AccumulableInfo>>[] accumUpdates, org.apache.spark.storage.BlockManagerId blockManagerId, scala.collection.mutable.Map<scala.Tuple2<java.lang.Object, java.lang.Object>, org.apache.spark.executor.ExecutorMetrics> executorUpdates)  { throw new RuntimeException(); }
  /**
   ...
   * @param task (undocumented)
   * @param taskIndex (undocumented)
   */
  public  void speculativeTaskSubmitted (org.apache.spark.scheduler.Task<?> task, int taskIndex)  { throw new RuntimeException(); }
  /**
  ...
  public  void unschedulableTaskSetRemoved (int stageId, int stageAttemptId)  { throw new RuntimeException(); }
    scala.collection.immutable.IndexedSeq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> getCacheLocs (org.apache.spark.rdd.RDD<?> rdd)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> org.apache.spark.scheduler.JobWaiter<U> submitJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.collection.immutable.Seq<java.lang.Object> partitions, org.apache.spark.util.CallSite callSite, scala.Function2<java.lang.Object, U, scala.runtime.BoxedUnit> resultHandler, java.util.Properties properties)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object, U extends java.lang.Object> void runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.collection.immutable.Seq<java.lang.Object> partitions, org.apache.spark.util.CallSite callSite, scala.Function2<java.lang.Object, U, scala.runtime.BoxedUnit> resultHandler, java.util.Properties properties)  { throw new RuntimeException(); }
  /**
   ...
   * @param reason (undocumented)
   */
  public  void cancelJobGroup (java.lang.String groupId, boolean cancelFutureJobs, scala.Option<java.lang.String> reason)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void cancelJobsWithTag (java.lang.String tag, scala.Option<java.lang.String> reason, scala.Option<scala.concurrent.Promise<scala.collection.immutable.Seq<org.apache.spark.scheduler.ActiveJob>>> cancelledJobs)  { throw new RuntimeException(); }
  /**
   ...
   */
    ...
    void handleJobGroupCancelled (java.lang.String groupId, boolean cancelFutureJobs, scala.Option<java.lang.String> reason)  { throw new RuntimeException(); }
    void handleJobTagCancelled (java.lang.String tag, scala.Option<java.lang.String> reason, scala.Option<scala.concurrent.Promise<scala.collection.immutable.Seq<org.apache.spark.scheduler.ActiveJob>>> cancelledJobs)  { throw new RuntimeException(); }
    ...
    void handleSpeculativeTaskSubmitted (org.apache.spark.scheduler.Task<?> task, int taskIndex)  { throw new RuntimeException(); }
    ...
    void handleStageFailed (int stageId, java.lang.String reason, scala.Option<java.lang.Throwable> exception)  { throw new RuntimeException(); }
    ...
    void handleJobSubmitted (int jobId, org.apache.spark.rdd.RDD<?> finalRDD, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<java.lang.Object>, ?> func, int[] partitions, org.apache.spark.util.CallSite callSite, org.apache.spark.scheduler.JobListener listener, org.apache.spark.JobArtifactSet artifacts, java.util.Properties properties)  { throw new RuntimeException(); }
    void handleMapStageSubmitted (int jobId, org.apache.spark.ShuffleDependency<?, ?, ?> dependency, org.apache.spark.util.CallSite callSite, org.apache.spark.scheduler.JobListener listener, org.apache.spark.JobArtifactSet artifacts, java.util.Properties properties)  { throw new RuntimeException(); }
   ...
   * @param mapStage (undocumented)
   */
    void rollbackSucceedingStages (org.apache.spark.scheduler.ShuffleMapStage mapStage)  { throw new RuntimeException(); }
  /**
   ...
   * @param taskScheduler (undocumented)
   * @param bmAddress (undocumented)
   * @return (undocumented)
   */
    boolean isExecutorDecommissioningOrDecommissioned (org.apache.spark.scheduler.TaskScheduler taskScheduler, org.apache.spark.storage.BlockManagerId bmAddress)  { throw new RuntimeException(); }
  /**
   ...
   */
    ...
    void handleRegisterMergeStatuses (org.apache.spark.scheduler.ShuffleMapStage stage, scala.collection.immutable.Seq<scala.Tuple2<java.lang.Object, org.apache.spark.scheduler.MergeStatus>> mergeStatuses)  { throw new RuntimeException(); }
   ...
   */
    ...
    void handleShuffleStatusNotFoundException (org.apache.spark.ShuffleStatusNotFoundException ex)  { throw new RuntimeException(); }
  /**
   * Called by the OutputCommitCoordinator to cancel stage due to data duplication may happen.
   * @param stageId (undocumented)
   * @param reason (undocumented)
   */
    void stageFailed (int stageId, java.lang.String reason)  { throw new RuntimeException(); }
  /**
