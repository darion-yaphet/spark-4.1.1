...
public  class DAGSchedulerSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.TempLocalSparkContext, org.scalatest.concurrent.TimeLimits {
  ...
  static public  org.apache.spark.scheduler.MapStatus makeMapStatus (java.lang.String host, int reduces, byte sizes, long mapTaskId, long checksumVal)  { throw new RuntimeException(); }
  static public  org.apache.spark.storage.BlockManagerId makeBlockManagerId (java.lang.String host, scala.Option<java.lang.String> execId)  { throw new RuntimeException(); }
  static public  org.apache.spark.scheduler.MergeStatus makeMergeStatus (java.lang.String host, int shuffleMergeId, long size, boolean isShufflePushMerger)  { throw new RuntimeException(); }
  static public  void addMergerLocs (scala.collection.immutable.Seq<java.lang.String> locs)  { throw new RuntimeException(); }
  ...
  public  scala.collection.mutable.HashMap<java.lang.Object, scala.collection.mutable.HashSet<java.lang.Object>> runningTaskInfos ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.scheduler.DAGSchedulerEventProcessLoopTester dagEventProcessLoopTester ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.mutable.HashMap<scala.Tuple2<java.lang.Object, java.lang.Object>, scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId>> cacheLocations ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.Tuple2<org.apache.spark.ShuffleDependency<?, ?, ?>, org.apache.spark.ShuffleDependency<?, ?, ?>> constructMixedDeterminateDependencies ()  { throw new RuntimeException(); }
}
