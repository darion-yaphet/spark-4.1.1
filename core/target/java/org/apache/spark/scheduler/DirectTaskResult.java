...
/** A TaskResult that contains the task's return value, accumulator updates and metric peaks. */
  ...
  // not preceding
  public   DirectTaskResult (org.apache.spark.util.io.ChunkedByteBuffer valueByteBuffer, scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accumUpdates, long[] metricPeaks)  { throw new RuntimeException(); }
  public   DirectTaskResult (java.nio.ByteBuffer valueByteBuffer, scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accumUpdates, long[] metricPeaks)  { throw new RuntimeException(); }
  public   DirectTaskResult ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> accumUpdates ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.util.io.ChunkedByteBuffer valueByteBuffer ()  { throw new RuntimeException(); }
