...
/** A map stage as submitted to run as a separate job */
  class MapStageSubmitted implements org.apache.spark.scheduler.DAGSchedulerEvent, scala.Product, java.io.Serializable {
  ...
  // not preceding
  public   MapStageSubmitted (int jobId, org.apache.spark.ShuffleDependency<?, ?, ?> dependency, org.apache.spark.util.CallSite callSite, org.apache.spark.scheduler.JobListener listener, org.apache.spark.JobArtifactSet artifactSet, java.util.Properties properties)  { throw new RuntimeException(); }
}
