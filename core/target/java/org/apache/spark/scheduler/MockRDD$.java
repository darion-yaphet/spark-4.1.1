...
public  class MockRDD$ extends org.scalatest.Assertions.AssertionsHelper implements org.scalactic.TripleEquals, org.scalatest.Assertions, java.io.Serializable {
  /**
   ...
   */
  public  void validate (int numPartitions, scala.collection.immutable.Seq<org.apache.spark.ShuffleDependency<?, ?, ?>> shuffleDependencies, scala.collection.immutable.Seq<org.apache.spark.OneToOneDependency<?>> oneToOneDependencies)  { throw new RuntimeException(); }
}
