 ...
 */
public  class MyRDD extends org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, java.lang.Object>> implements java.io.Serializable {
  public   MyRDD (org.apache.spark.SparkContext sc, int numPartitions, scala.collection.immutable.List<org.apache.spark.Dependency<?>> dependencies, scala.collection.immutable.Seq<scala.collection.immutable.Seq<java.lang.String>> locations, org.apache.spark.MapOutputTrackerMaster tracker, boolean indeterminate)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<java.lang.String> getPreferredLocations (org.apache.spark.Partition partition)  { throw new RuntimeException(); }
