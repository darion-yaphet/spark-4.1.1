 ...
 */
  ...
  // not preceding
  public   ResultStage (int id, org.apache.spark.rdd.RDD<?> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<java.lang.Object>, ?> func, int[] partitions, scala.collection.immutable.List<org.apache.spark.scheduler.Stage> parents, int firstJobId, org.apache.spark.util.CallSite callSite, int resourceProfileId)  { throw new RuntimeException(); }
  /**
