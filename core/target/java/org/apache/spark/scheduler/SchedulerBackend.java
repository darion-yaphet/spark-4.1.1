...
public  interface SchedulerBackend {
   ...
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getShufflePushMergerLocations (int numPartitions, int resourceProfileId)  ;
  public  scala.Option<org.apache.spark.status.api.v1.ThreadStackTrace> getTaskThreadDump (long taskId, java.lang.String executorId)  ;
  ...
  public  void updateExecutorsLogLevel (java.lang.String logLevel)  ;
}
