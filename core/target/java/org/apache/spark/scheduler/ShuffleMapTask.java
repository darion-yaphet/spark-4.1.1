 ...
 */
  ...
  // not preceding
  public   ShuffleMapTask (int stageId, int stageAttemptId, org.apache.spark.broadcast.Broadcast<byte[]> taskBinary, org.apache.spark.Partition partition, int numPartitions, scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation> locs, org.apache.spark.JobArtifactSet artifacts, java.util.Properties localProperties, byte[] serializedTaskMetrics, scala.Option<java.lang.Object> jobId, scala.Option<java.lang.String> appId, scala.Option<java.lang.String> appAttemptId, boolean isBarrier)  { throw new RuntimeException(); }
