 ...
 */
 abstract class Stage implements org.apache.spark.internal.Logging {
  ...
  public abstract  scala.collection.immutable.Seq<java.lang.Object> findMissingPartitions ()  ;
  public  int firstJobId ()  { throw new RuntimeException(); }
    int getNextAttemptId ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
    boolean isChecksumMismatched ()  { throw new RuntimeException(); }
  public  boolean isIndeterminate ()  { throw new RuntimeException(); }
  public  boolean isParentIndeterminate ()  { throw new RuntimeException(); }
  public  boolean isStageIndeterminate ()  { throw new RuntimeException(); }
  ...
  public  void makeNewStageAttempt (int numPartitionsToCompute, scala.collection.immutable.Seq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> taskLocalityPreferences)  { throw new RuntimeException(); }
  /** Mark the latest attempt as rollback */
    void markAsRollingBack ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    scala.Option<java.lang.Object> maxAttemptIdToIgnore ()  { throw new RuntimeException(); }
  /**
   * The maximum of task attempt id where checksum mismatches are detected.
   * @return (undocumented)
   */
    int maxChecksumMismatchedId ()  { throw new RuntimeException(); }
