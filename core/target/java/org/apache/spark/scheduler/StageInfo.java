...
public  class StageInfo {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.scheduler.StageInfo fromStage (org.apache.spark.scheduler.Stage stage, int attemptId, scala.Option<java.lang.Object> numTasks, org.apache.spark.executor.TaskMetrics taskMetrics, scala.collection.immutable.Seq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> taskLocalityPreferences, int resourceProfileId)  { throw new RuntimeException(); }
  public  int stageId ()  { throw new RuntimeException(); }
  public  java.lang.String name ()  { throw new RuntimeException(); }
  public  int numTasks ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> rddInfos ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<java.lang.Object> parentIds ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.executor.TaskMetrics taskMetrics ()  { throw new RuntimeException(); }
    scala.collection.immutable.Seq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> taskLocalityPreferences ()  { throw new RuntimeException(); }
  ...
  public  int resourceProfileId ()  { throw new RuntimeException(); }
    boolean isShufflePushEnabled ()  { throw new RuntimeException(); }
    int shuffleMergerCount ()  { throw new RuntimeException(); }
  // not preceding
  public   StageInfo (int stageId, int attemptId, java.lang.String name, int numTasks, scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> rddInfos, scala.collection.immutable.Seq<java.lang.Object> parentIds, java.lang.String details, org.apache.spark.executor.TaskMetrics taskMetrics, scala.collection.immutable.Seq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> taskLocalityPreferences, scala.Option<java.lang.Object> shuffleDepId, int resourceProfileId, boolean isShufflePushEnabled, int shuffleMergerCount)  { throw new RuntimeException(); }
