 ...
 */
 abstract class Task<T extends java.lang.Object> implements java.io.Serializable, org.apache.spark.internal.Logging {
  public  int stageId ()  { throw new RuntimeException(); }
  public  int stageAttemptId ()  { throw new RuntimeException(); }
  public  int partitionId ()  { throw new RuntimeException(); }
  public  int numPartitions ()  { throw new RuntimeException(); }
  public  org.apache.spark.JobArtifactSet artifacts ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   Task (int stageId, int stageAttemptId, int partitionId, int numPartitions, org.apache.spark.JobArtifactSet artifacts, java.util.Properties localProperties, byte[] serializedTaskMetrics, scala.Option<java.lang.Object> jobId, scala.Option<java.lang.String> appId, scala.Option<java.lang.String> appAttemptId, boolean isBarrier)  { throw new RuntimeException(); }
  // not preceding
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> collectAccumulatorUpdates (boolean taskFailed)  { throw new RuntimeException(); }
  /**
