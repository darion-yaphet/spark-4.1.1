 ...
 */
public  class TaskInfo implements java.lang.Cloneable {
  // not preceding
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.AccumulableInfo> accumulables ()  { throw new RuntimeException(); }
  public  int attemptNumber ()  { throw new RuntimeException(); }
  public  org.apache.spark.scheduler.TaskInfo clone ()  { throw new RuntimeException(); }
    org.apache.spark.scheduler.TaskInfo cloneWithEmptyAccumulables ()  { throw new RuntimeException(); }
  ...
  public  boolean killed ()  { throw new RuntimeException(); }
    void launchSucceeded ()  { throw new RuntimeException(); }
  public  long launchTime ()  { throw new RuntimeException(); }
  public  boolean launching ()  { throw new RuntimeException(); }
  ...
  public  boolean running ()  { throw new RuntimeException(); }
    void setAccumulables (scala.collection.immutable.Seq<org.apache.spark.scheduler.AccumulableInfo> newAccumulables)  { throw new RuntimeException(); }
