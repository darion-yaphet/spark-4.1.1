 ...
 */
   ...
   * tasks with the <code>rpId</code> can be used to calculate the task slots.
   * <p>
  ...
  public  long MIN_TIME_TO_SPECULATION ()  { throw new RuntimeException(); }
    boolean efficientTaskCalcualtionEnabled ()  { throw new RuntimeException(); }
  ...
  public  com.google.common.cache.Cache<java.lang.String, org.apache.spark.scheduler.ExecutorDecommissionState> executorsRemovedByDecom ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskDescription>> resourceOffers (scala.collection.immutable.IndexedSeq<org.apache.spark.scheduler.WorkerOffer> offers, boolean isAllFreeResources)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  protected  scala.collection.immutable.IndexedSeq<org.apache.spark.scheduler.WorkerOffer> shuffleOffers (scala.collection.immutable.IndexedSeq<org.apache.spark.scheduler.WorkerOffer> offers)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.Option<java.lang.String>> getRacksForHosts (scala.collection.immutable.Seq<java.lang.String> hosts)  { throw new RuntimeException(); }
