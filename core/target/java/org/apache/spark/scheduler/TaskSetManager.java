 ...
 */
   ...
   */
    class TaskProcessRateCalculator {
    public   TaskProcessRateCalculator ()  { throw new RuntimeException(); }
      double getAvgTaskProcessRate ()  { throw new RuntimeException(); }
      double getRunningTasksProcessRate (long taskId)  { throw new RuntimeException(); }
      void updateAvgTaskProcessRate (long taskId, org.apache.spark.scheduler.DirectTaskResult<?> result)  { throw new RuntimeException(); }
      void updateRunningTaskProcessRate (long taskId, double taskProcessRate)  { throw new RuntimeException(); }
  }
  ...
  public  boolean speculationTasksLessEqToSlots ()  { throw new RuntimeException(); }
    scala.Option<org.apache.spark.scheduler.TaskSetManager.TaskProcessRateCalculator> taskProcessRateCalculator ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.util.collection.PercentileHeap successfulTaskDurations ()  { throw new RuntimeException(); }
  ...
  public  scala.Enumeration.Value schedulingMode ()  { throw new RuntimeException(); }
    ...
    boolean dropTaskInfoAccumulablesOnTaskCompletion ()  { throw new RuntimeException(); }
  ...
  public  void suspend ()  { throw new RuntimeException(); }
