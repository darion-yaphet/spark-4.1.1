 ...
 */
  ...
  // not preceding
  public   LocalEndpoint (org.apache.spark.rpc.RpcEnv rpcEnv, scala.collection.immutable.Seq<java.net.URL> userClassPath, org.apache.spark.scheduler.TaskSchedulerImpl scheduler, org.apache.spark.scheduler.local.LocalSchedulerBackend executorBackend, int totalCores)  { throw new RuntimeException(); }
