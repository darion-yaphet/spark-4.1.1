 ...
 */
   ...
   * @param socket (undocumented)
   */
  public  void authClient (java.nio.channels.SocketChannel socket)  { throw new RuntimeException(); }
   ...
   * @param socket (undocumented)
   */
  public  void authToServer (java.nio.channels.SocketChannel socket)  { throw new RuntimeException(); }
  ...
  // not preceding
  public  java.lang.String sockDir ()  { throw new RuntimeException(); }
