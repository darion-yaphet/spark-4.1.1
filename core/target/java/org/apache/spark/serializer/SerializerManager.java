 ...
 */
  ...
  /** Generate a `SerializationStream` for a block. */
   <T extends java.lang.Object> org.apache.spark.serializer.SerializationStream blockSerializationStream (org.apache.spark.storage.BlockId blockId, java.io.OutputStream outputStream, scala.reflect.ClassTag<T> classTag)  { throw new RuntimeException(); }
  ...
  /** Serializes into a chunked byte buffer. */
  public  org.apache.spark.util.io.ChunkedByteBuffer dataSerializeWithExplicitClassTag (org.apache.spark.storage.BlockId blockId, scala.collection.Iterator<java.lang.Object> values, scala.reflect.ClassTag<?> classTag)  { throw new RuntimeException(); }
