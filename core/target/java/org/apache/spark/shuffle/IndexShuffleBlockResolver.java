 ...
 */
  ...
  public  java.util.concurrent.ConcurrentMap<java.lang.Object, org.apache.spark.util.collection.OpenHashSet<java.lang.Object>> taskIdMapsForShuffle ()  { throw new RuntimeException(); }
  // not preceding
  public   IndexShuffleBlockResolver (org.apache.spark.SparkConf conf, org.apache.spark.storage.BlockManager _blockManager, java.util.concurrent.ConcurrentMap<java.lang.Object, org.apache.spark.util.collection.OpenHashSet<java.lang.Object>> taskIdMapsForShuffle)  { throw new RuntimeException(); }
  ...
  public   IndexShuffleBlockResolver (org.apache.spark.SparkConf conf, java.util.concurrent.ConcurrentHashMap<java.lang.Object, org.apache.spark.util.collection.OpenHashSet<java.lang.Object>> taskIdMapsForShuffle)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.shuffle.ShuffleBlockInfo> getStoredShuffles ()  { throw new RuntimeException(); }
  public  void addShuffleToSkip (int shuffleId)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.network.buffer.ManagedBuffer> getMergedBlockData (org.apache.spark.storage.ShuffleMergedBlockId blockId, scala.Option<java.lang.String[]> dirs)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockId> getBlocksForShuffle (int shuffleId, long mapId)  { throw new RuntimeException(); }
