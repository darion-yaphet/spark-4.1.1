 ...
 */
   ...
   */
  static   class PushRequest implements scala.Product, java.io.Serializable {
    public  org.apache.spark.storage.BlockManagerId address ()  { throw new RuntimeException(); }
    public  scala.collection.immutable.Seq<scala.Tuple2<org.apache.spark.storage.BlockId, java.lang.Object>> blocks ()  { throw new RuntimeException(); }
    public  org.apache.spark.network.buffer.ManagedBuffer reqBuffer ()  { throw new RuntimeException(); }
    // not preceding
    public   PushRequest (org.apache.spark.storage.BlockManagerId address, scala.collection.immutable.Seq<scala.Tuple2<org.apache.spark.storage.BlockId, java.lang.Object>> blocks, org.apache.spark.network.buffer.ManagedBuffer reqBuffer)  { throw new RuntimeException(); }
    public  int size ()  { throw new RuntimeException(); }
  }
  static public  class PushRequest$ extends scala.runtime.AbstractFunction3<org.apache.spark.storage.BlockManagerId, scala.collection.immutable.Seq<scala.Tuple2<org.apache.spark.storage.BlockId, java.lang.Object>>, org.apache.spark.network.buffer.ManagedBuffer, org.apache.spark.shuffle.ShuffleBlockPusher.PushRequest> implements java.io.Serializable {
    /**
   ...
   * VisibleForTesting
   */
    scala.collection.immutable.Seq<org.apache.spark.shuffle.ShuffleBlockPusher.PushRequest> prepareBlockPushRequests (int numPartitions, int partitionId, int shuffleId, int shuffleMergeId, java.io.File dataFile, long[] partitionLengths, scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> mergerLocs, org.apache.spark.network.util.TransportConf transportConf)  { throw new RuntimeException(); }
