...
public  interface ShuffleBlockResolver {
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockId> getBlocksForShuffle (int shuffleId, long mapId)  ;
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.network.buffer.ManagedBuffer> getMergedBlockData (org.apache.spark.storage.ShuffleMergedBlockId blockId, scala.Option<java.lang.String[]> dirs)  ;
  /**
