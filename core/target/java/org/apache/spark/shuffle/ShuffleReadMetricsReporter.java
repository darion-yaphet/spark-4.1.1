...
public  interface ShuffleReadMetricsReporter {
    void incCorruptMergedBlockChunks (long v)  ;
    void incFetchWaitTime (long v)  ;
    void incLocalBlocksFetched (long v)  ;
    void incLocalBytesRead (long v)  ;
    void incLocalMergedBlocksFetched (long v)  ;
    void incLocalMergedBytesRead (long v)  ;
    void incLocalMergedChunksFetched (long v)  ;
    void incMergedFetchFallbackCount (long v)  ;
    ...
    void incRemoteMergedBlocksFetched (long v)  ;
    void incRemoteMergedBytesRead (long v)  ;
    void incRemoteMergedChunksFetched (long v)  ;
    void incRemoteMergedReqsDuration (long v)  ;
    void incRemoteReqsDuration (long v)  ;
}
