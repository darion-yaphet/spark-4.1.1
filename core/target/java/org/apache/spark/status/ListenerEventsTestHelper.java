...
public  class ListenerEventsTestHelper {
  static public  class JobInfo implements scala.Product, java.io.Serializable {
    public  scala.collection.immutable.Seq<java.lang.Object> stageIds ()  { throw new RuntimeException(); }
    public  scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>> stageToTaskIds ()  { throw new RuntimeException(); }
    public  scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>> stageToRddIds ()  { throw new RuntimeException(); }
    // not preceding
    public   JobInfo (scala.collection.immutable.Seq<java.lang.Object> stageIds, scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>> stageToTaskIds, scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>> stageToRddIds)  { throw new RuntimeException(); }
  }
  static public  class JobInfo$ extends scala.runtime.AbstractFunction3<scala.collection.immutable.Seq<java.lang.Object>, scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>>, scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<java.lang.Object>>, org.apache.spark.status.ListenerEventsTestHelper.JobInfo> implements java.io.Serializable {
    /**
  ...
  static public  scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> createRddsWithId (scala.collection.immutable.Seq<java.lang.Object> ids)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> createRdds (int count)  { throw new RuntimeException(); }
  static public  org.apache.spark.scheduler.StageInfo createStage (int id, scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> rdds, scala.collection.immutable.Seq<java.lang.Object> parentIds)  { throw new RuntimeException(); }
  static public  org.apache.spark.scheduler.StageInfo createStage (scala.collection.immutable.Seq<org.apache.spark.storage.RDDInfo> rdds, scala.collection.immutable.Seq<java.lang.Object> parentIds)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskInfo> createTasks (scala.collection.immutable.Seq<java.lang.Object> ids, java.lang.String[] execs, long time)  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskInfo> createTasks (int count, java.lang.String[] execs, long time)  { throw new RuntimeException(); }
