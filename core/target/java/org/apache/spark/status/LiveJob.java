...
public  class LiveJob extends org.apache.spark.status.LiveEntity {
  // not preceding
  public   LiveJob (int jobId, java.lang.String name, scala.Option<java.lang.String> description, scala.Option<java.util.Date> submissionTime, scala.collection.immutable.Seq<java.lang.Object> stageIds, scala.Option<java.lang.String> jobGroup, scala.collection.immutable.Seq<java.lang.String> jobTags, int numTasks, scala.Option<java.lang.Object> sqlExecutionId)  { throw new RuntimeException(); }
