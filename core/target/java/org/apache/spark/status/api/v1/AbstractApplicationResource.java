package org.apache.spark.status.api.v1;
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.ExecutorSummary> allExecutorList ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.ProcessSummary> allProcessList ()  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.ExecutorSummary> executorList ()  { throw new RuntimeException(); }
  public  jakarta.ws.rs.core.Response getEventLogs ()  { throw new RuntimeException(); }
  public  org.apache.spark.status.api.v1.ThreadStackTrace getTaskThreadDump (long taskId, java.lang.String execId)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.RDDStorageInfo> rddList ()  { throw new RuntimeException(); }
