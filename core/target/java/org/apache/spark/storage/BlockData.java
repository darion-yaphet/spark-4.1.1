 ...
 * data. Callers should call {@link BlockData#dispose()} when they're done with the block.
 */
public  interface BlockData {
   ...
   * Returns a Netty-friendly wrapper for the block's data.
   * <p>
   * Please see <code>ManagedBuffer.convertToNettyForSsl()</code> for more details.
   * @return (undocumented)
   */
  public  java.lang.Object toNettyForSsl ()  ;
}
