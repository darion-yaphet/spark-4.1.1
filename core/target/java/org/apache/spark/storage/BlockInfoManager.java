 ...
 */
  ...
  public   BlockInfoManager (boolean trackingCacheVisibility)  { throw new RuntimeException(); }
    boolean containsInvisibleRDDBlock (org.apache.spark.storage.RDDBlockId blockId)  { throw new RuntimeException(); }
    boolean isRDDBlockVisible (org.apache.spark.storage.RDDBlockId blockId)  { throw new RuntimeException(); }
    void tryMarkBlockAsVisible (org.apache.spark.storage.RDDBlockId blockId)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  boolean lockNewBlockForWriting (org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.BlockInfo newBlockInfo, boolean keepReadLock)  { throw new RuntimeException(); }
  /**
