 ...
 */
   ...
   */
    class ByteBufferBlockStoreUpdater<T extends java.lang.Object> extends org.apache.spark.storage.BlockManager.BlockStoreUpdater<T> implements scala.Product, java.io.Serializable {
    ...
    public  org.apache.spark.util.io.ChunkedByteBuffer bytes ()  { throw new RuntimeException(); }
    public  boolean tellMaster ()  { throw new RuntimeException(); }
    public  boolean keepReadLock ()  { throw new RuntimeException(); }
    // not preceding
    public   ByteBufferBlockStoreUpdater (org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.StorageLevel level, scala.reflect.ClassTag<T> classTag, org.apache.spark.util.io.ChunkedByteBuffer bytes, boolean tellMaster, boolean keepReadLock)  { throw new RuntimeException(); }
  ...
  public  class ByteBufferBlockStoreUpdater$ implements java.io.Serializable {
    public   ByteBufferBlockStoreUpdater$ ()  { throw new RuntimeException(); }
  }
  /**
   * Helper for storing a block based from bytes already in a local temp file.
   */
    class TempFileBasedBlockStoreUpdater<T extends java.lang.Object> extends org.apache.spark.storage.BlockManager.BlockStoreUpdater<T> implements scala.Product, java.io.Serializable {
    public  org.apache.spark.storage.BlockId blockId ()  { throw new RuntimeException(); }
    public  org.apache.spark.storage.StorageLevel level ()  { throw new RuntimeException(); }
    public  scala.reflect.ClassTag<T> classTag ()  { throw new RuntimeException(); }
  ...
  public  class TempFileBasedBlockStoreUpdater$ implements java.io.Serializable {
  ...
  static public  scala.collection.immutable.Map<org.apache.spark.storage.BlockId, scala.collection.immutable.Seq<java.lang.String>> blockIdsToLocations (org.apache.spark.storage.BlockId[] blockIds, org.apache.spark.SparkEnv env, org.apache.spark.storage.BlockManagerMaster blockManagerMaster)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   BlockManager (java.lang.String executorId, org.apache.spark.rpc.RpcEnv rpcEnv, org.apache.spark.storage.BlockManagerMaster master, org.apache.spark.serializer.SerializerManager serializerManager, org.apache.spark.SparkConf conf, org.apache.spark.memory.MemoryManager _memoryManager, org.apache.spark.MapOutputTracker mapOutputTracker, org.apache.spark.shuffle.ShuffleManager _shuffleManager, org.apache.spark.network.BlockTransferService blockTransferService, org.apache.spark.SecurityManager securityManager, scala.Option<org.apache.spark.network.shuffle.ExternalBlockStoreClient> externalBlockStoreClient)  { throw new RuntimeException(); }
  // not preceding
    org.apache.spark.memory.MemoryManager memoryManager ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public  org.apache.spark.shuffle.MigratableResolver migratableResolver ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.network.buffer.ManagedBuffer> getLocalMergedBlockData (org.apache.spark.storage.ShuffleMergedBlockId blockId, java.lang.String[] dirs)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockId> getMatchingBlockIds (scala.Function1<org.apache.spark.storage.BlockId, java.lang.Object> filter)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> sortLocations (scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> locations)  { throw new RuntimeException(); }
  /**
   ...
   * @param taskAttemptId (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockId> releaseAllLocksForTask (long taskAttemptId)  { throw new RuntimeException(); }
  /**
   * Retrieve the given rdd block if it exists and is visible, otherwise call the provided
   * <code>makeIterator</code> method to compute the block, persist it, and return its values.
   * <p>
   ...
   */
  public <T extends java.lang.Object> scala.util.Either<org.apache.spark.storage.BlockResult, scala.collection.Iterator<T>> getOrElseUpdateRDDBlock (long taskId, org.apache.spark.storage.RDDBlockId blockId, org.apache.spark.storage.StorageLevel level, scala.reflect.ClassTag<T> classTag, scala.Function0<scala.collection.Iterator<T>> makeIterator)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * To get a log block writer that can write logs directly to a disk block. Either <code>save</code> or
   * <code>close</code> should be called to finish the writing and release opened resources.
   * <code>save</code> would write the block to the block manager, while <code>close</code> would just close the writer.
   * @param logBlockType (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.storage.LogBlockWriter getLogBlockWriter (scala.Enumeration.Value logBlockType)  { throw new RuntimeException(); }
  /**
   ...
   * @param blockIdGenerator (undocumented)
   * @param rollingSize (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.storage.RollingLogWriter getRollingLogWriter (org.apache.spark.storage.LogBlockIdGenerator blockIdGenerator, long rollingSize)  { throw new RuntimeException(); }
  /**
  ...
  public <T extends java.lang.Object> boolean putBytes (org.apache.spark.storage.BlockId blockId, org.apache.spark.util.io.ChunkedByteBuffer bytes, org.apache.spark.storage.StorageLevel level, boolean tellMaster, scala.reflect.ClassTag<T> evidence$4)  { throw new RuntimeException(); }
    boolean isRDDBlockVisible (org.apache.spark.storage.RDDBlockId blockId)  { throw new RuntimeException(); }
  /**
   * Get peer block managers in the system.
   * @param forceFetch (undocumented)
   * @return (undocumented)
   */
    scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getPeers (boolean forceFetch)  { throw new RuntimeException(); }
  /**
   ...
   */
    ...
    scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerMessages.ReplicateBlock> getMigratableRDDBlocks ()  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * @return The number of blocks removed.
   * @param sessionUUID (undocumented)
   */
  public  int removeCache (java.lang.String sessionUUID)  { throw new RuntimeException(); }
  /**
