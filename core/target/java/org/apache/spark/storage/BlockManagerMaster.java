package org.apache.spark.storage;
   ...
   */
  public  void decommissionBlockManagers (scala.collection.immutable.Seq<java.lang.String> executorIds)  { throw new RuntimeException(); }
  /** Get Replication Info for all the RDD blocks stored in given blockManagerId */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerMessages.ReplicateBlock> getReplicateInfoForRDDBlocks (org.apache.spark.storage.BlockManagerId blockManagerId)  { throw new RuntimeException(); }
   ...
   * @param isReRegister (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.storage.BlockManagerId registerBlockManager (org.apache.spark.storage.BlockManagerId id, java.lang.String[] localDirs, long maxOnHeapMemSize, long maxOffHeapMemSize, org.apache.spark.rpc.RpcEndpointRef storageEndpoint, boolean isReRegister)  { throw new RuntimeException(); }
  ...
  public  void updateRDDBlockTaskInfo (org.apache.spark.storage.RDDBlockId blockId, long taskId)  { throw new RuntimeException(); }
  public  void updateRDDBlockVisibility (long taskId, boolean visible)  { throw new RuntimeException(); }
  /** Check whether a block is visible */
  public  boolean isRDDBlockVisible (org.apache.spark.storage.RDDBlockId blockId)  { throw new RuntimeException(); }
  /** Get locations of the blockId from the driver */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getLocations (org.apache.spark.storage.BlockId blockId)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.IndexedSeq<scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId>> getLocations (org.apache.spark.storage.BlockId[] blockIds)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getPeers (org.apache.spark.storage.BlockManagerId blockManagerId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> getShufflePushMergerLocations (int numMergersNeeded, scala.collection.immutable.Set<java.lang.String> hostsToFilter)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.storage.BlockId> getMatchingBlockIds (scala.Function1<org.apache.spark.storage.BlockId, java.lang.Object> filter, boolean askStorageEndpoints)  { throw new RuntimeException(); }
