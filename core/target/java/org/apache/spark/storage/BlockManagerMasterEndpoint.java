...
/**
 * BlockManagerMasterEndpoint is an {@link IsolatedThreadSafeRpcEndpoint} on the master node to
 * track statuses of all the storage endpoints' block managers.
 */
  class BlockManagerMasterEndpoint implements org.apache.spark.rpc.IsolatedThreadSafeRpcEndpoint, org.apache.spark.internal.Logging {
  // not preceding
  public   BlockManagerMasterEndpoint (org.apache.spark.rpc.RpcEnv rpcEnv, boolean isLocal, org.apache.spark.SparkConf conf, org.apache.spark.scheduler.LiveListenerBus listenerBus, scala.Option<org.apache.spark.network.shuffle.ExternalBlockStoreClient> externalBlockStoreClient, scala.collection.mutable.Map<org.apache.spark.storage.BlockManagerId, org.apache.spark.storage.BlockManagerInfo> blockManagerInfo, org.apache.spark.MapOutputTrackerMaster mapOutputTracker, org.apache.spark.shuffle.ShuffleManager _shuffleManager, boolean isDriver)  { throw new RuntimeException(); }
