...
public  interface BlockManagerReplicationBehavior extends org.scalatest.matchers.must.Matchers, org.scalatest.BeforeAndAfter, org.apache.spark.LocalSparkContext {
  ...
  public  org.apache.spark.SparkConf createConf ()  ;
   ...
   */
  public  void testReplication (int maxReplication, scala.collection.immutable.Seq<org.apache.spark.storage.StorageLevel> storageLevels)  ;
}
