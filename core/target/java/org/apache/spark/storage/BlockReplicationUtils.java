...
public  class BlockReplicationUtils {
   ...
   */
  static public <T extends java.lang.Object> scala.collection.immutable.List<T> getRandomSample (scala.collection.immutable.Seq<T> elems, int m, scala.util.Random r)  { throw new RuntimeException(); }
}
