...
public  class FallbackStorage$ implements org.apache.spark.internal.Logging {
  ...
  public  void registerBlockManagerIfNeeded (org.apache.spark.storage.BlockManagerMaster master, org.apache.spark.SparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  /** Clean up the generated fallback location for this app (and shuffle id if given). */
  public  void cleanUp (org.apache.spark.SparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf, scala.Option<java.lang.Object> shuffleId)  { throw new RuntimeException(); }
  /**
