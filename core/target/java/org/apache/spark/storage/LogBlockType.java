...
public  class LogBlockType {
  static public  scala.Enumeration.Value TEST ()  { throw new RuntimeException(); }
  static public  scala.Enumeration.Value PYTHON_WORKER ()  { throw new RuntimeException(); }
