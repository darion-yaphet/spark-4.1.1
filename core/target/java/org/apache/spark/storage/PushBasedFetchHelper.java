...
public  class PushBasedFetchHelper implements org.apache.spark.internal.Logging {
  // not preceding
  public   PushBasedFetchHelper (org.apache.spark.storage.ShuffleBlockFetcherIterator iterator, org.apache.spark.network.shuffle.BlockStoreClient shuffleClient, org.apache.spark.storage.BlockManager blockManager, org.apache.spark.MapOutputTracker mapOutputTracker, org.apache.spark.shuffle.ShuffleReadMetricsReporter shuffleMetrics)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Option<org.roaringbitmap.RoaringBitmap> getRoaringBitMap (org.apache.spark.storage.ShuffleBlockChunkId blockId)  { throw new RuntimeException(); }
  /**
   * Get the number of map blocks in a ShuffleBlockChunk
   * @param blockId
   * @return
   */
  public  int getShuffleChunkCardinality (org.apache.spark.storage.ShuffleBlockChunkId blockId)  { throw new RuntimeException(); }
  /**
   * This is executed by the task thread when the <code>iterator.next()</code> is invoked and the iterator
