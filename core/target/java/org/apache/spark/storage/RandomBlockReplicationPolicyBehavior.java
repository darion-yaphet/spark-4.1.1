...
public  class RandomBlockReplicationPolicyBehavior extends org.apache.spark.SparkFunSuite implements org.scalatest.matchers.must.Matchers, org.scalatest.BeforeAndAfter, org.apache.spark.LocalSparkContext {
   ...
   * @return (undocumented)
   */
  protected  scala.collection.immutable.Seq<org.apache.spark.storage.BlockManagerId> generateBlockManagerIds (int count, scala.collection.immutable.Seq<java.lang.String> racks)  { throw new RuntimeException(); }
