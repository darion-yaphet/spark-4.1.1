...
public  class JettyUtils {
  static public  class ServletParams<T extends java.lang.Object> {
    public  scala.Function1<jakarta.servlet.http.HttpServletRequest, T> responder ()  { throw new RuntimeException(); }
    ...
    // not preceding
    public   ServletParams (scala.Function1<jakarta.servlet.http.HttpServletRequest, T> responder, java.lang.String contentType, scala.Function1<T, java.lang.String> extractFn)  { throw new RuntimeException(); }
  }
  ...
  static public  org.apache.spark.ui.JettyUtils.ServletParams<org.json4s.JValue> jsonResponderToServlet (scala.Function1<jakarta.servlet.http.HttpServletRequest, org.json4s.JValue> responder)  { throw new RuntimeException(); }
  static public  org.apache.spark.ui.JettyUtils.ServletParams<scala.collection.immutable.Seq<scala.xml.Node>> htmlResponderToServlet (scala.Function1<jakarta.servlet.http.HttpServletRequest, scala.collection.immutable.Seq<scala.xml.Node>> responder)  { throw new RuntimeException(); }
  static public  org.apache.spark.ui.JettyUtils.ServletParams<java.lang.String> textResponderToServlet (scala.Function1<jakarta.servlet.http.HttpServletRequest, java.lang.String> responder)  { throw new RuntimeException(); }
  ...
  /** Create a context handler that responds to a request with the given path prefix */
  static public  org.eclipse.jetty.servlet.ServletContextHandler createServletHandler (java.lang.String path, jakarta.servlet.http.HttpServlet servlet, java.lang.String basePath)  { throw new RuntimeException(); }
  /** Create a handler that always redirects the user to the given path */
  static public  org.eclipse.jetty.servlet.ServletContextHandler createRedirectHandler (java.lang.String srcPath, java.lang.String destPath, scala.Function1<jakarta.servlet.http.HttpServletRequest, scala.runtime.BoxedUnit> beforeRedirect, java.lang.String basePath, scala.collection.immutable.Set<java.lang.String> httpMethods)  { throw new RuntimeException(); }
  ...
  static public  java.lang.String createProxyLocationHeader (java.lang.String headerValue, jakarta.servlet.http.HttpServletRequest clientRequest, java.net.URI targetUri)  { throw new RuntimeException(); }
  ...
  static public  java.lang.String[] toVirtualHosts (scala.collection.immutable.Seq<java.lang.String> connectors)  { throw new RuntimeException(); }
