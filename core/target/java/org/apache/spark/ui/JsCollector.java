 ...
 */
  class JsCollector {
  public   JsCollector (jakarta.servlet.http.HttpServletRequest req)  { throw new RuntimeException(); }
  public  void addImports (java.lang.String sourceFile, scala.collection.immutable.Seq<java.lang.String> functions)  { throw new RuntimeException(); }
  public  void addImports (java.lang.String js)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<scala.xml.Node> toHtml ()  { throw new RuntimeException(); }
}
