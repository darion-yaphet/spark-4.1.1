...
public  interface PagedTable<T extends java.lang.Object> {
   ...
   * @return (undocumented)
   */
  public  java.lang.String getParameterOtherTable (jakarta.servlet.http.HttpServletRequest request, java.lang.String tableTag)  ;
  /**
   ...
   * @return (undocumented)
   */
  public  scala.Tuple3<java.lang.String, java.lang.Object, java.lang.Object> getTableParameters (jakarta.servlet.http.HttpServletRequest request, java.lang.String tableTag, java.lang.String defaultSortColumn)  ;
  /**
   * Returns the submission path for the "go to page #" form.
   * @return (undocumented)
   */
  public  java.lang.String goButtonFormPath ()  ;
  public  scala.collection.immutable.Seq<scala.xml.Node> headerRow (scala.collection.immutable.Seq<scala.Tuple3<java.lang.String, java.lang.Object, scala.Option<java.lang.String>>> headerInfo, boolean desc, int pageSize, java.lang.String sortColumn, java.lang.String parameterPath, java.lang.String tableTag, java.lang.String headerId)  ;
  public  scala.collection.immutable.Seq<scala.xml.Node> headers ()  ;
  /**
   ...
   */
  public  void isSortColumnValid (scala.collection.immutable.Seq<scala.Tuple3<java.lang.String, java.lang.Object, scala.Option<java.lang.String>>> headerInfo, java.lang.String sortColumn)  ;
  /**
   ...
   * @return (undocumented)
   */
    scala.collection.immutable.Seq<scala.xml.Node> pageNavigation (int page, int pageSize, int totalPages, java.lang.String navigationId)  ;
  public  java.lang.String pageNumberFormField ()  ;
  public  java.lang.String pageSizeFormField ()  ;
  public  scala.collection.immutable.Seq<scala.xml.Node> row (T t)  ;
  public  scala.collection.immutable.Seq<scala.xml.Node> table (int page)  ;
