...
public  class UIUtils$ implements org.apache.spark.internal.Logging {
  ...
  public  java.lang.String uiRoot (jakarta.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  java.lang.String prependBaseUri (jakarta.servlet.http.HttpServletRequest request, java.lang.String basePath, java.lang.String resource)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<scala.xml.Node> commonHeaderNodes (jakarta.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<scala.xml.Node> vizHeaderNodes (jakarta.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<scala.xml.Node> dataTablesHeaderNodes (jakarta.servlet.http.HttpServletRequest request)  { throw new RuntimeException(); }
  /** Returns a spark page with correctly formatted headers */
  public  scala.collection.immutable.Seq<scala.xml.Node> headerSparkPage (jakarta.servlet.http.HttpServletRequest request, java.lang.String title, scala.Function0<scala.collection.immutable.Seq<scala.xml.Node>> content, org.apache.spark.ui.SparkUITab activeTab, scala.Option<java.lang.String> helpText, boolean showVisualization, boolean useDataTables)  { throw new RuntimeException(); }
  /** Returns a page with the spark css/js and a simple format. Used for scheduler UI. */
  public  scala.collection.immutable.Seq<scala.xml.Node> basicSparkPage (jakarta.servlet.http.HttpServletRequest request, scala.Function0<scala.collection.immutable.Seq<scala.xml.Node>> content, java.lang.String title, boolean useDataTables)  { throw new RuntimeException(); }
  /** Returns an HTML table constructed by generating a row for each object in a sequence. */
  public <T extends java.lang.Object> scala.collection.immutable.Seq<scala.xml.Node> listingTable (scala.collection.immutable.Seq<java.lang.String> headers, scala.Function1<T, scala.collection.immutable.Seq<scala.xml.Node>> generateDataRow, scala.collection.Iterable<T> data, boolean fixedWidth, scala.Option<java.lang.String> id, scala.collection.immutable.Seq<java.lang.String> headerClasses, boolean stripeRowsWithCss, boolean sortable, scala.collection.immutable.Seq<scala.Option<java.lang.String>> tooltipHeaders)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<scala.xml.Node> makeProgressBar (int started, int completed, int failed, int skipped, scala.collection.immutable.Map<java.lang.String, java.lang.Object> reasonToNumKilled, int total)  { throw new RuntimeException(); }
  /** Return a "DAG visualization" DOM element that expands into a visualization for a stage. */
  public  scala.collection.immutable.Seq<scala.xml.Node> showDagVizForStage (int stageId, scala.Option<org.apache.spark.ui.scope.RDDOperationGraph> graph)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<scala.xml.Node> tooltip (java.lang.String text, java.lang.String position)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.glassfish.jersey.internal.util.collection.MultivaluedStringMap decodeURLParameter (jakarta.ws.rs.core.MultivaluedMap<java.lang.String, java.lang.String> params)  { throw new RuntimeException(); }
  ...
  public  jakarta.ws.rs.core.Response buildErrorResponse (jakarta.ws.rs.core.Response.Status status, java.lang.String msg)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<scala.xml.Node> detailsUINode (boolean isMultiline, java.lang.String message)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.Tuple2<java.lang.String, java.lang.Object> errorSummary (java.lang.String errorMessage)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<scala.xml.Node> errorMessageCell (java.lang.String errorMessage)  { throw new RuntimeException(); }
  public  java.lang.String formatImportJavaScript (jakarta.servlet.http.HttpServletRequest request, java.lang.String sourceFile, scala.collection.immutable.Seq<java.lang.String> methods)  { throw new RuntimeException(); }
}
