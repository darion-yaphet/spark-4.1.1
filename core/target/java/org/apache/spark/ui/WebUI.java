 ...
 */
 abstract class WebUI implements org.apache.spark.internal.Logging {
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.ui.WebUITab> getTabs ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.eclipse.jetty.servlet.ServletContextHandler> getHandlers ()  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.ui.DelegatingServletContextHandler> getDelegatingHandlers ()  { throw new RuntimeException(); }
  ...
  /** Attaches a handler to this UI. */
  public  void attachHandler (java.lang.String contextPath, jakarta.servlet.http.HttpServlet httpServlet, java.lang.String pathSpec)  { throw new RuntimeException(); }
