 ...
 */
public abstract class AccumulatorV2<IN extends java.lang.Object, OUT extends java.lang.Object> implements java.io.Serializable {
  // not preceding
  ...
  public  boolean excludeFromHeartbeat ()  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Creates an {@link AccumulableInfo} representation of this {@link AccumulatorV2} as an update.
   * @return (undocumented)
   */
    org.apache.spark.scheduler.AccumulableInfo toInfoUpdate ()  { throw new RuntimeException(); }
