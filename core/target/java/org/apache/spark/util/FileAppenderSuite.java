...
public  class FileAppenderSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.BeforeAndAfter {
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.io.File> testRolling (org.apache.spark.util.logging.FileAppender appender, java.io.OutputStream outputStream, scala.collection.immutable.Seq<java.lang.String> textToAppend, long sleepTimeBetweenTexts, boolean isCompressed)  { throw new RuntimeException(); }
}
