...
public  class ThreadUtils$ {
   ...
   * @return (undocumented)
   */
  public  java.util.concurrent.ThreadPoolExecutor newDaemonSingleThreadExecutor (java.lang.String threadName)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.util.concurrent.ThreadPoolExecutor newDaemonSingleThreadExecutorWithRejectedExecutionHandler (java.lang.String threadName, int taskQueueCapacity, java.util.concurrent.RejectedExecutionHandler rejectedExecutionHandler)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  java.util.concurrent.ExecutorService newDaemonBlockingThreadPoolExecutorService (int nThreads, int workQueueSize, java.lang.String prefix)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.util.concurrent.ScheduledThreadPoolExecutor newSingleThreadScheduledExecutor (java.lang.String threadName)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Throwable> T wrapCallerStacktrace (T realException, java.lang.String combineMessage, int dropStacks)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <I extends java.lang.Object, O extends java.lang.Object> scala.collection.immutable.Seq<O> parmap (scala.collection.immutable.Seq<I> in, java.lang.String prefix, int maxThreads, scala.Function1<I, O> f)  { throw new RuntimeException(); }
}
