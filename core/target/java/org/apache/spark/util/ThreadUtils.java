...
public  class ThreadUtils {
   ...
   * @return (undocumented)
   */
  static public  java.util.concurrent.ThreadPoolExecutor newDaemonSingleThreadExecutor (java.lang.String threadName)  { throw new RuntimeException(); }
  /**
   * Wrapper over newSingleThreadExecutor that allows the specification
   * of a RejectedExecutionHandler
   * @param threadName (undocumented)
   * @param taskQueueCapacity (undocumented)
   * @param rejectedExecutionHandler (undocumented)
   * @return (undocumented)
   */
  static public  java.util.concurrent.ThreadPoolExecutor newDaemonSingleThreadExecutorWithRejectedExecutionHandler (java.lang.String threadName, int taskQueueCapacity, java.util.concurrent.RejectedExecutionHandler rejectedExecutionHandler)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public  java.util.concurrent.ExecutorService newDaemonBlockingThreadPoolExecutorService (int nThreads, int workQueueSize, java.lang.String prefix)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  java.util.concurrent.ScheduledThreadPoolExecutor newSingleThreadScheduledExecutor (java.lang.String threadName)  { throw new RuntimeException(); }
  /**
   ...
   *   at CallerClass.caller-method (sourcefile.scala)
   *   ...
   * @param realException (undocumented)
   * @param combineMessage (undocumented)
   * @param dropStacks (undocumented)
   * @return (undocumented)
   */
  static public <T extends java.lang.Throwable> T wrapCallerStacktrace (T realException, java.lang.String combineMessage, int dropStacks)  { throw new RuntimeException(); }
  /**
   ...
   */
  static public <I extends java.lang.Object, O extends java.lang.Object> scala.collection.immutable.Seq<O> parmap (scala.collection.immutable.Seq<I> in, java.lang.String prefix, int maxThreads, scala.Function1<I, O> f)  { throw new RuntimeException(); }
}
