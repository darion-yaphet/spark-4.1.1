 ...
 * <p>
 * The main difference between this and {@link BestEffortLazyVal} is that:
 * {@link BestEffortLazyVal} serializes the cached value after computation, while
 * {@link TransientBestEffortLazyVal} always serializes the compute function.
 * <p>
 * @note
 ...
 */
  class TransientBestEffortLazyVal<T extends java.lang.Object> implements java.io.Serializable {
  // not preceding
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree().setOriginal(Select(Ident(scala), TypeName("AnyRef")))))
  public   TransientBestEffortLazyVal (scala.Function0<T> compute)  { throw new RuntimeException(); }
