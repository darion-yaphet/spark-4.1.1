 ...
 */
public  class Utils$ implements org.apache.spark.internal.Logging, org.apache.spark.util.SparkClassUtils, org.apache.spark.util.SparkEnvUtils, org.apache.spark.util.SparkErrorUtils, org.apache.spark.util.SparkFileUtils, org.apache.spark.util.SparkSerDeUtils, org.apache.spark.util.SparkStreamUtils, org.apache.spark.util.SparkStringUtils, org.apache.spark.util.SparkSystemUtils {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final Utils$ MODULE$ = null;
  public  java.lang.String osName ()  { throw new RuntimeException(); }
  public  java.lang.String osVersion ()  { throw new RuntimeException(); }
  public  java.lang.String osArch ()  { throw new RuntimeException(); }
  ...
  public  boolean isLinux ()  { throw new RuntimeException(); }
  public  boolean isUnix ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  java.io.File createExecutorLocalTempDir (org.apache.spark.SparkConf conf, java.lang.String namePrefix)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String encodeRelativeUnixPathToURIRawPath (java.lang.String path)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.io.File fetchFile (java.lang.String url, java.io.File targetDir, org.apache.spark.ReadOnlySparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf, long timestamp, boolean useCache, boolean shouldUntar)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.io.File doFetchFile (java.lang.String url, java.io.File targetDir, java.lang.String filename, org.apache.spark.ReadOnlySparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
  /**
   ...
   * @param filename (undocumented)
   */
    void fetchHcfsFile (org.apache.hadoop.fs.Path path, java.io.File targetDir, org.apache.hadoop.fs.FileSystem fs, org.apache.spark.ReadOnlySparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf, boolean fileOverwrite, scala.Option<java.lang.String> filename)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String getLocalDir (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
    boolean isRunningInYarnContainer (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
    java.lang.String[] getOrCreateLocalRootDirs (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String[] getConfiguredLocalDirs (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> scala.collection.immutable.Seq<T> randomize (scala.collection.IterableOnce<T> seq, scala.reflect.ClassTag<T> evidence$1)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String localHostNameForURI ()  { throw new RuntimeException(); }
    java.lang.String addBracketsIfNeeded (java.lang.String addr)  { throw new RuntimeException(); }
  /**
   * Normalize IPv6 IPs and no-op on all other hosts.
   * @param host (undocumented)
   * @return (undocumented)
   */
    java.lang.String normalizeIpIfNeeded (java.lang.String host)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.Process executeCommand (scala.collection.immutable.Seq<java.lang.String> command, java.io.File workingDir, scala.collection.Map<java.lang.String, java.lang.String> extraEnvironment, boolean redirectStderr)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String executeAndGetOutput (scala.collection.immutable.Seq<java.lang.String> command, java.io.File workingDir, scala.collection.Map<java.lang.String, java.lang.String> extraEnvironment, boolean redirectStderr)  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String TRY_WITH_CALLER_STACKTRACE_FULL_STACKTRACE ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> scala.util.Try<T> doTryWithCallerStacktrace (scala.Function0<T> f)  { throw new RuntimeException(); }
  /**
   ...
   */
  public <T extends java.lang.Object> T getTryWithCallerStacktrace (scala.util.Try<T> t)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long getFileLength (java.io.File file, org.apache.spark.ReadOnlySparkConf workConf)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  java.lang.String offsetBytes (scala.collection.immutable.Seq<java.io.File> files, scala.collection.immutable.Seq<java.lang.Object> fileLengths, long start, long end)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> splitCommandString (java.lang.String s)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  long getIteratorSize (scala.collection.Iterator<java.lang.Object> iterator)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean isJavaVersionAtMost17 ()  { throw new RuntimeException(); }
  /**
   * Whether the underlying Java version is at least 21.
   * @return (undocumented)
   */
  public  boolean isJavaVersionAtLeast21 ()  { throw new RuntimeException(); }
  /**
   * Whether the underlying JVM prefer IPv6 addresses.
   * @return (undocumented)
   */
  public  boolean preferIPv6 ()  { throw new RuntimeException(); }
  /**
  ...
  public  java.lang.String CONNECT_EXECUTE_THREAD_PREFIX ()  { throw new RuntimeException(); }
    scala.math.Ordering<java.lang.management.ThreadInfo> threadInfoOrdering ()  { throw new RuntimeException(); }
  ...
  public  java.lang.String[] getHeapHistogram ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> sparkJavaOpts (org.apache.spark.ReadOnlySparkConf conf, scala.Function1<java.lang.String, java.lang.Object> filterKey)  { throw new RuntimeException(); }
  /**
   * Maximum number of retries when binding to a port before giving up.
   * @param conf (undocumented)
   * @return (undocumented)
   */
  public  int portMaxRetries (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> scala.Tuple2<T, java.lang.Object> startServiceOnPort (int startPort, scala.Function1<java.lang.Object, scala.Tuple2<T, java.lang.Object>> startService, org.apache.spark.ReadOnlySparkConf conf, java.lang.String serviceName)  { throw new RuntimeException(); }
  /**
   * Attempt to start a service on the given port, or fail after a number of attempts.
   ...
   */
  public <T extends java.lang.Object> scala.Tuple2<T, java.lang.Object> startServiceOnPort (int startPort, scala.Function1<java.lang.Object, scala.Tuple2<T, java.lang.Object>> startService, int maxRetries, java.lang.String serviceName)  { throw new RuntimeException(); }
  /**
  ...
  public  void setLogLevelIfNeeded (java.lang.String newLogLevel)  { throw new RuntimeException(); }
  /**
   * Get current log level
   * @return (undocumented)
   */
  public  java.lang.String getLogLevel ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String libraryPathEnvPrefix (scala.collection.immutable.Seq<java.lang.String> libraryPaths)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Set<java.lang.String> getCurrentUserGroups (org.apache.spark.ReadOnlySparkConf sparkConf, java.lang.String username)  { throw new RuntimeException(); }
  /**
   ...
   * @param conf (undocumented)
   */
  public  boolean isLocalMaster (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean isDynamicAllocationEnabled (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  public  boolean isStreamingDynamicAllocationEnabled (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   * Return the initial number of executors for dynamic allocation.
   * @param conf (undocumented)
   * @return (undocumented)
   */
  public  int getDynamicAllocationInitialExecutors (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void resetStructuredLogging ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void resetStructuredLogging (org.apache.spark.ReadOnlySparkConf sparkConf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> getUserJars (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.lang.String> getLocalUserJarsForShell (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> redact (org.apache.spark.ReadOnlySparkConf conf, scala.collection.Seq<scala.Tuple2<java.lang.String, java.lang.String>> kvs)  { throw new RuntimeException(); }
  /**
   * Redact the sensitive values in the given map. If a map key matches the redaction pattern then
   * its value is replaced with a dummy text.
  ...
  public  scala.collection.immutable.Seq<java.lang.String> redactCommandLineArgs (org.apache.spark.ReadOnlySparkConf conf, scala.collection.immutable.Seq<java.lang.String> commands)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> scala.collection.immutable.Seq<T> loadExtensions (java.lang.Class<T> extClass, scala.collection.immutable.Seq<java.lang.String> classes, org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String substituteSparkVersion (java.lang.String opt)  { throw new RuntimeException(); }
  public  java.lang.String createSecret (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /**
  ...
  public  boolean isClientMode (org.apache.spark.ReadOnlySparkConf conf)  { throw new RuntimeException(); }
  /** Returns whether the URI is a "local:" URI. */
  public  boolean isLocalUri (java.lang.String uri)  { throw new RuntimeException(); }
  /** Create a UriBuilder from URI object. */
  public  jakarta.ws.rs.core.UriBuilder getUriBuilder (java.net.URI uri)  { throw new RuntimeException(); }
  /** Create a UriBuilder from URI string. */
  public  jakarta.ws.rs.core.UriBuilder getUriBuilder (java.lang.String uri)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  java.lang.String buildLocationMetadata (scala.collection.immutable.Seq<org.apache.hadoop.fs.Path> paths, int stopAppendingThreshold)  { throw new RuntimeException(); }
  /**
   * Convert MEMORY_OFFHEAP_SIZE to MB Unit, return 0 if MEMORY_OFFHEAP_ENABLED is false.
   * @param sparkConf (undocumented)
   * @return (undocumented)
   */
  public  int executorOffHeapMemorySizeAsMb (org.apache.spark.ReadOnlySparkConf sparkConf)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  long checkOffHeapEnabled (org.apache.spark.ReadOnlySparkConf sparkConf, long offHeapSize)  { throw new RuntimeException(); }
  /** Returns a string message about delegation token generation failure */
  public  org.apache.spark.internal.MessageWithContext createFailedToGetTokenMessage (java.lang.String serviceName)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<java.io.File> unzipFilesFromFile (org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.Path dfsZipFile, java.io.File localDir)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <R extends java.io.Closeable> R createResourceUninterruptiblyIfInTaskThread (scala.Function0<R> createResource)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  boolean checkCommandAvailable (java.lang.String command)  { throw new RuntimeException(); }
  // not preceding
  public  boolean isSerialGC ()  { throw new RuntimeException(); }
  // not preceding
  public  boolean isParallelGC ()  { throw new RuntimeException(); }
  // not preceding
  public  boolean isG1GC ()  { throw new RuntimeException(); }
  // not preceding
  public  boolean isZGC ()  { throw new RuntimeException(); }
  // not preceding
  public  boolean isShenandoahGC ()  { throw new RuntimeException(); }
  public  boolean checkUseGC (java.lang.String useGCObjectStr)  { throw new RuntimeException(); }
  /**
   * Return a string of printStackTrace result.
   * @param e (undocumented)
   * @return (undocumented)
   */
  public  java.lang.String stringifyException (java.lang.Throwable e)  { throw new RuntimeException(); }
}
