 ...
 */
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  public   ExternalSorter (org.apache.spark.TaskContext context, scala.Option<org.apache.spark.Aggregator<K, V, C>> aggregator, scala.Option<org.apache.spark.Partitioner> partitioner, scala.Option<scala.math.Ordering<K>> ordering, org.apache.spark.serializer.Serializer serializer, org.apache.spark.shuffle.checksum.RowBasedChecksum[] rowBasedChecksums)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.shuffle.checksum.RowBasedChecksum[] getRowBasedChecksums ()  { throw new RuntimeException(); }
  public  long getAggregatedChecksumValue ()  { throw new RuntimeException(); }
  /**
   ...
   */
  public  void writePartitionedMapOutput (int shuffleId, long mapId, org.apache.spark.shuffle.api.ShuffleMapOutputWriter mapOutputWriter, org.apache.spark.shuffle.ShuffleWriteMetricsReporter writeMetrics)  { throw new RuntimeException(); }
