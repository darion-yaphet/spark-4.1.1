 ...
 *               them as needed.
 */
  class ChunkedByteBuffer implements java.io.Externalizable {
   ...
   * @return (undocumented)
   */
  static public  int estimateBufferChunkSize (long estimatedSize)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  io.netty.handler.stream.ChunkedStream toNettyForSsl ()  { throw new RuntimeException(); }
  /**
