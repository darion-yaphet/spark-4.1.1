package org.apache.spark.status.api.v1.streaming;
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.streaming.BatchInfo> batchesList (java.util.List<org.apache.spark.status.api.v1.streaming.BatchStatus> statusParams)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.streaming.OutputOperationInfo> operationsList (long batchId)  { throw new RuntimeException(); }
  public  scala.collection.immutable.Seq<org.apache.spark.status.api.v1.streaming.ReceiverInfo> receiversList ()  { throw new RuntimeException(); }
