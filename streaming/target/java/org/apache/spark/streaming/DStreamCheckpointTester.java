...
public  interface DStreamCheckpointTester {
  public <V extends java.lang.Object> void assertOutput (scala.collection.immutable.Seq<scala.collection.immutable.Seq<V>> output, scala.collection.immutable.Seq<scala.collection.immutable.Seq<V>> expectedOutput, boolean beforeRestart, scala.reflect.ClassTag<V> evidence$5)  ;
  ...
  public <V extends java.lang.Object> scala.collection.immutable.Seq<scala.collection.immutable.Seq<V>> generateOutput (org.apache.spark.streaming.StreamingContext ssc, org.apache.spark.streaming.Time targetBatchTime, java.lang.String checkpointDir, boolean stopSparkContext, scala.reflect.ClassTag<V> evidence$4)  ;
  /**
   ...
   */
  public <U extends java.lang.Object, V extends java.lang.Object> void testCheckpointedOperation (scala.collection.immutable.Seq<scala.collection.immutable.Seq<U>> input, scala.Function1<org.apache.spark.streaming.dstream.DStream<U>, org.apache.spark.streaming.dstream.DStream<V>> operation, scala.collection.immutable.Seq<scala.collection.immutable.Seq<V>> expectedOutput, int numBatchesBeforeRestart, org.apache.spark.streaming.Duration batchDuration, boolean stopSparkContextAfterTest, scala.reflect.ClassTag<U> evidence$1, scala.reflect.ClassTag<V> evidence$2)  ;
}
