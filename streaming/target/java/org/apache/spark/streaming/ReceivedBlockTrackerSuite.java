...
public  class ReceivedBlockTrackerSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.BeforeAndAfter, org.scalatest.matchers.must.Matchers {
  ...
  public  org.apache.spark.streaming.scheduler.BatchAllocationEvent createBatchAllocation (long time, scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockInfo> blockInfos)  { throw new RuntimeException(); }
  /** Create batch clean object from the given info */
  public  org.apache.spark.streaming.scheduler.BatchCleanupEvent createBatchCleanup (long time, scala.collection.immutable.Seq<java.lang.Object> moreTimes)  { throw new RuntimeException(); }
  /**
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockInfo> generateBlockInfos (int blockCount)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Seq<java.lang.String> getWriteAheadLogFiles ()  { throw new RuntimeException(); }
  /** Get all the data written in the given write ahead log file. */
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockTrackerLogEvent> getWrittenLogData (java.lang.String logFile)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockTrackerLogEvent> getWrittenLogData (scala.collection.immutable.Seq<java.lang.String> logFiles)  { throw new RuntimeException(); }
   ...
   */
  public  void writeEventsManually (java.lang.String filePath, scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockTrackerLogEvent> events)  { throw new RuntimeException(); }
}
