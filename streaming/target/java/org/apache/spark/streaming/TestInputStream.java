...
public  class TestInputStream<T extends java.lang.Object> extends org.apache.spark.streaming.dstream.InputDStream<T> {
  ...
  public   TestInputStream (org.apache.spark.streaming.StreamingContext _ssc, scala.collection.immutable.Seq<scala.collection.immutable.Seq<T>> input, int numPartitions, scala.reflect.ClassTag<T> evidence$1)  { throw new RuntimeException(); }
