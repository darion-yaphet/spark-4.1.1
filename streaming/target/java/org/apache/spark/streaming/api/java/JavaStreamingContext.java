...
public  class JavaStreamingContext implements java.io.Closeable {
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object> org.apache.spark.streaming.api.java.JavaDStream<T> union (scala.collection.immutable.Seq<org.apache.spark.streaming.api.java.JavaDStream<T>> jdstreams)  { throw new RuntimeException(); }
  /**
   * Create a unified DStream from multiple DStreams of the same type and same slide duration.
   * @param jdstreams (undocumented)
   * @return (undocumented)
   */
  public <K extends java.lang.Object, V extends java.lang.Object> org.apache.spark.streaming.api.java.JavaPairDStream<K, V> union (scala.collection.immutable.Seq<org.apache.spark.streaming.api.java.JavaPairDStream<K, V>> jdstreams)  { throw new RuntimeException(); }
  /**
