package org.apache.spark.streaming.dstream;
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  public   FlatMappedDStream (org.apache.spark.streaming.dstream.DStream<T> parent, scala.Function1<T, scala.collection.IterableOnce<U>> flatMapFunc, scala.reflect.ClassTag<T> evidence$1, scala.reflect.ClassTag<U> evidence$2)  { throw new RuntimeException(); }
