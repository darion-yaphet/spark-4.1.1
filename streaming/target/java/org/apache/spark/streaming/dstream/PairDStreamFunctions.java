 ...
 */
public  class PairDStreamFunctions<K extends java.lang.Object, V extends java.lang.Object> implements java.io.Serializable {
  // not preceding
   ...
   * @return (undocumented)
   */
  public <U extends java.lang.Object> org.apache.spark.streaming.dstream.DStream<scala.Tuple2<K, U>> flatMapValues (scala.Function1<V, scala.collection.IterableOnce<U>> flatMapValuesFunc, scala.reflect.ClassTag<U> evidence$12)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object> org.apache.spark.streaming.dstream.DStream<scala.Tuple2<K, S>> updateStateByKey (scala.Function2<scala.collection.immutable.Seq<V>, scala.Option<S>, scala.Option<S>> updateFunc, scala.reflect.ClassTag<S> evidence$4)  { throw new RuntimeException(); }
  /**
   * Return a new "state" DStream where the state for each key is updated by applying
   * the given function on the previous state of the key and the new values of each key.
   * In every batch the updateFunc will be called for each state even if there are no new values.
   ...
   * @return (undocumented)
   */
  public <S extends java.lang.Object> org.apache.spark.streaming.dstream.DStream<scala.Tuple2<K, S>> updateStateByKey (scala.Function2<scala.collection.immutable.Seq<V>, scala.Option<S>, scala.Option<S>> updateFunc, int numPartitions, scala.reflect.ClassTag<S> evidence$5)  { throw new RuntimeException(); }
  /**
   * Return a new "state" DStream where the state for each key is updated by applying
