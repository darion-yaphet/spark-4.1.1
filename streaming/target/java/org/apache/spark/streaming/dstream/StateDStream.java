package org.apache.spark.streaming.dstream;
  ...
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree(), TypeTree()))
  public   StateDStream (org.apache.spark.streaming.dstream.DStream<scala.Tuple2<K, V>> parent, scala.Function2<org.apache.spark.streaming.Time, scala.collection.Iterator<scala.Tuple3<K, scala.collection.immutable.Seq<V>, scala.Option<S>>>, scala.collection.Iterator<scala.Tuple2<K, S>>> updateFunc, org.apache.spark.Partitioner partitioner, boolean preservePartitioning, scala.Option<org.apache.spark.rdd.RDD<scala.Tuple2<K, S>>> initialRDD, scala.reflect.ClassTag<K> evidence$1, scala.reflect.ClassTag<V> evidence$2, scala.reflect.ClassTag<S> evidence$3)  { throw new RuntimeException(); }
