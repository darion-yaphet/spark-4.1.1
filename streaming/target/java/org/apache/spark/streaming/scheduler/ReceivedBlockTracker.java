 ...
 */
  ...
  public   ReceivedBlockTracker (org.apache.spark.SparkConf conf, org.apache.hadoop.conf.Configuration hadoopConf, scala.collection.immutable.Seq<java.lang.Object> streamIds, org.apache.spark.util.Clock clock, boolean recoverFromWriteAheadLog, scala.Option<java.lang.String> checkpointDirOption)  { throw new RuntimeException(); }
  ...
  public  scala.collection.immutable.Map<java.lang.Object, scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockInfo>> getBlocksOfBatch (org.apache.spark.streaming.Time batchTime)  { throw new RuntimeException(); }
  /** Get the blocks allocated to the given batch and stream. */
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockInfo> getBlocksOfBatchAndStream (org.apache.spark.streaming.Time batchTime, int streamId)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.scheduler.ReceivedBlockInfo> getUnallocatedBlocks (int streamId)  { throw new RuntimeException(); }
  /**
