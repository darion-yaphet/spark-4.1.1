 ...
 */
   ...
   * @return (undocumented)
   */
  public  scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation> rescheduleReceiver (int receiverId, scala.Option<java.lang.String> preferredLocation, scala.collection.Map<java.lang.Object, org.apache.spark.streaming.scheduler.ReceiverTrackingInfo> receiverTrackingInfoMap, scala.collection.immutable.Seq<org.apache.spark.scheduler.ExecutorCacheTaskLocation> executors)  { throw new RuntimeException(); }
  /**
   ...
   * @param executors (undocumented)
   */
  public  scala.collection.Map<java.lang.Object, scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> scheduleReceivers (scala.collection.immutable.Seq<org.apache.spark.streaming.receiver.Receiver<?>> receivers, scala.collection.immutable.Seq<org.apache.spark.scheduler.ExecutorCacheTaskLocation> executors)  { throw new RuntimeException(); }
}
