 ...
 */
  class ReceiverTrackingInfo implements scala.Product, java.io.Serializable {
  ...
  public  scala.Option<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> scheduledLocations ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   ReceiverTrackingInfo (int receiverId, scala.Enumeration.Value state, scala.Option<scala.collection.immutable.Seq<org.apache.spark.scheduler.TaskLocation>> scheduledLocations, scala.Option<org.apache.spark.scheduler.ExecutorCacheTaskLocation> runningExecutor, scala.Option<java.lang.String> name, scala.Option<org.apache.spark.rpc.RpcEndpointRef> endpoint, scala.Option<org.apache.spark.streaming.scheduler.ReceiverErrorInfo> errorInfo)  { throw new RuntimeException(); }
