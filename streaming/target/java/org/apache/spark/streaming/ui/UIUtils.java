...
public  class UIUtils {
  ...
  static public  scala.collection.immutable.Seq<scala.xml.Node> failureReasonCell (java.lang.String failureReason, int rowspan, boolean includeFirstLineInExpandDetails)  { throw new RuntimeException(); }
}
