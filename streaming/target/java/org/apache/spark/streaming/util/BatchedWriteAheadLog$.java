...
public  class BatchedWriteAheadLog$ {
  ...
  public  java.nio.ByteBuffer aggregate (scala.collection.immutable.Seq<org.apache.spark.streaming.util.BatchedWriteAheadLog.Record> records)  { throw new RuntimeException(); }
  /**
