 ...
 */
   ...
   */
  static public  class Record implements scala.Product, java.io.Serializable {
  ...
  static public  class Record$ extends scala.runtime.AbstractFunction3<java.nio.ByteBuffer, java.lang.Object, scala.concurrent.Promise<org.apache.spark.streaming.util.WriteAheadLogRecordHandle>, org.apache.spark.streaming.util.BatchedWriteAheadLog.Record> implements java.io.Serializable {
    /**
  ...
  static public  java.nio.ByteBuffer aggregate (scala.collection.immutable.Seq<org.apache.spark.streaming.util.BatchedWriteAheadLog.Record> records)  { throw new RuntimeException(); }
  /**
