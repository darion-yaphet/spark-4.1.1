...
public  class FileBasedWriteAheadLog$ {
  ...
  public  scala.collection.immutable.Seq<org.apache.spark.streaming.util.FileBasedWriteAheadLog.LogInfo> logFilesTologInfo (scala.collection.immutable.Seq<org.apache.hadoop.fs.Path> files)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <I extends java.lang.Object, O extends java.lang.Object> scala.collection.Iterator<O> seqToParIterator (scala.concurrent.ExecutionContext executionContext, scala.collection.immutable.Seq<I> source, scala.Function1<I, scala.collection.Iterator<O>> handler)  { throw new RuntimeException(); }
}
