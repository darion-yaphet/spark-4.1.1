...
public  class WriteAheadLogSuite {
  ...
  static public  scala.collection.immutable.Seq<org.apache.spark.streaming.util.FileBasedWriteAheadLogSegment> writeDataManually (scala.collection.immutable.Seq<java.lang.String> data, java.lang.String file, boolean allowBatching)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.collection.immutable.Seq<org.apache.spark.streaming.util.FileBasedWriteAheadLogSegment> writeDataUsingWriter (java.lang.String filePath, scala.collection.immutable.Seq<java.lang.String> data)  { throw new RuntimeException(); }
  /** Write data to rotating files in log directory using the WriteAheadLog class. */
  static public  org.apache.spark.streaming.util.WriteAheadLog writeDataUsingWriteAheadLog (java.lang.String logDirectory, scala.collection.immutable.Seq<java.lang.String> data, boolean closeFileAfterWrite, boolean allowBatching, org.apache.spark.util.ManualClock manualClock, boolean closeLog, int clockAdvanceTime)  { throw new RuntimeException(); }
  /** Read data from a segments of a log file directly and return the list of byte buffers. */
  static public  scala.collection.immutable.Seq<java.lang.String> readDataManually (scala.collection.immutable.Seq<org.apache.spark.streaming.util.FileBasedWriteAheadLogSegment> segments)  { throw new RuntimeException(); }
  /** Read all the data from a log file directly and return the list of byte buffers. */
  static public <T extends java.lang.Object> scala.collection.immutable.Seq<T> readDataManually (java.lang.String file)  { throw new RuntimeException(); }
  /** Read all the data from a log file using reader class and return the list of byte buffers. */
  static public  scala.collection.immutable.Seq<java.lang.String> readDataUsingReader (java.lang.String file)  { throw new RuntimeException(); }
  /** Read all the data in the log file in a directory using the WriteAheadLog class. */
  static public  scala.collection.immutable.Seq<java.lang.String> readDataUsingWriteAheadLog (java.lang.String logDirectory, boolean closeFileAfterWrite, boolean allowBatching)  { throw new RuntimeException(); }
  /** Get the log files in a directory. */
  static public  scala.collection.immutable.Seq<java.lang.String> getLogFilesInDirectory (java.lang.String directory)  { throw new RuntimeException(); }
  ...
  static public  scala.collection.immutable.Seq<java.lang.String> generateRandomData ()  { throw new RuntimeException(); }
  static public  scala.collection.immutable.Seq<java.lang.String> readAndDeserializeDataManually (scala.collection.immutable.Seq<java.lang.String> logFiles, boolean allowBatching)  { throw new RuntimeException(); }
